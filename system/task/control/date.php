...
class dateControl extends BaseCronControl {
            ...
            for ($i=0; $i<$countnum; $i+=100){//每次查询100条
                ...
                if ($orderlog_list){
                    ...
                    foreach ((array)$ordergoods_list as $k=>$v){
                        ...
                        $tmp['reciver_city_id_id'] = $order_common_list[$v['order_id']]['reciver_city_id_id'];
                        $tmp['reciver_area_id_id'] = $order_common_list[$v['order_id']]['reciver_area_id_id'];
    ...
    private function _fenxiao_goods_close(){
        ...
        $model_fx_goods->dbDelDistriGoods($condition);
    }
}