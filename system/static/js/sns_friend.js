$(function(){
	...
	$("[wt_type='followbtn']").live('click',function(){
        ...
        $.getJSON(MEMBER_SITE_URL + '/index.php/member_snsfriend/addfollow?mid='+data_str.mid, function(data){
        	if(data){
	...
	$("[wt_type='cancelbtn']").live('click',function(){
		var data_str = $(this).attr('data-param');
        eval( "data_str = "+data_str);
        $.getJSON(MEMBER_SITE_URL + '/index.php/member_snsfriend/delfollow?mid='+data_str.mid, function(data){
        	if(data){
	...
	$('*[wttype="batchFollow"]').live('click', function(){
		...
		ajax_get_confirm('',MEMBER_SITE_URL + '/index.php/member_snsfriend/batch_addfollow?ids='+data_str.ids);
	});
});