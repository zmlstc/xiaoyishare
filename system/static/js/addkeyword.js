...
function zsc_show(id){
	...
	if(zsc_class!='add'){
		...
		var url = "index.php/seller_wechat/addkeyword_ajax?kid="+zsc_id;
...
function btnsave(num,count){
	...
	if(ktype==1){
		...
		if(count==0){
			var url = "index.php/seller_wechat/keyword_index?opt=add";
			...
			var url = "index.php/seller_wechat/keyword_index?opt=update";
			var kid = $('#zsc_iid').val();
...
function zscdel(num){
	...
	var url = "index.php/seller_wechat/keyword_index?opt=del";
	...
	$("input[name='"+file_id+"']").bind("change",function(){			
		...
		$(obj).parent().find(".fileuploading").addClass("show");
		  $.ajaxFileUpload
		   (
			   {
					url:"index.php/seller_wechat/upload_fm",
				    secureuri:false,
