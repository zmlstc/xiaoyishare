...
class store_sns_tracelogModel extends Model {
    ...
    public function spellingStyle($type,$data){
        ...
        switch ($type){
            ...
            case '6':
                $rs = "<div class=\"fd-media\">
                    <div class=\"goodsimg\"><a target=\"_blank\" href=\"" . urlShop('show_store', 'index', array('store_id'=>$data['store_id'])) . "\"><img src=\"" . SHOP_TEMPLATES_URL . "/images/give-img.gif\" onload=\"javascript:DrawImage(this,120,120);\" alt=\"".$data['ansong_name']."\"></a></div>
                        <div class=\"goodsinfo\">
                        <dl>
