    ...
    public function pdPay($order_info, $input, $buyer_info) {
        ...
        //foreach ($order_list as $key => $order_info) {
            ...
            if ($available_pd_amount >= $order_amount) {
				...
				$data_order['invite_info'] = json_encode($invite_info);
                $data_order['seller_money'] = $seller_money;
                $data_order['commis_rate'] = $commis_rate;
                $data_order['sys_commis_momey'] = $sys_commis_momey+$cost_momey;
                $data_order['member_invite_momey'] = $member_invite_momey;
                $data_order['store_invite_momey'] = $store_invite_momey;
                $data_order['cost_momey'] = $cost_momey;
                $data_order['cost_points'] = $cost_points;
                $data_order['agent_commis_momey'] = $agent_momey;
                $data_order['agent_id'] = $storeinfo['agent_id'];
			   ...
			   if($member_invite_momey>0){
				   ...
				   if(!empty($member_invite_info) && is_array($member_invite_info)){
					   ...
					   $data['invite_member_name'] = $member_name;
