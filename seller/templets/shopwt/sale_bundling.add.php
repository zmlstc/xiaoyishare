...
<div class="wrap">
  ...
  <div class="wtsc-form-default"> 
    ...
    <form id="add_form" method="post" action="<?php echo urlSeller('sale_bundling','bundling_add');?>">
      ...
      <dl>
        ...
        <dd>
          ...
          <a id="bundling_add_goods" href="<?php echo urlSeller('sale_bundling','bundling_add_goods');?>" class="wtbtn wtbtn-aqua"><?php echo $lang['bundling_goods_add'];?></a>
