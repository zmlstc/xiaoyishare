...
<div class="tabmenu">
  ...
  <a href="javascript:void(0)" class="wtbtn wtbtn-mint" onclick="go('<?php echo urlSeller('account_group','group_add');?>');" title="添加账号"><i class="icon-group"></i>添加组</a> </div>
<table class="wtsc-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle"><span><a href="<?php echo urlSeller('account_group', 'group_edit', array('group_id' => $value['group_id']));?>" class="btn-bluejeans"><i class="icon-edit"></i>
...
<form id="del_form" method="post" action="<?php echo urlSeller('account_group', 'group_del');?>">
