...
<div class="tabmenu">
  <ul id="listpj" class="tab">
    <li class="active"><a href="<?php echo urlSeller('evaluate', 'list');?>"><?php echo $lang['member_evaluation_frombuyer'];?></a></li>
  </ul>
</div>
<form method="get" action="<?php echo urlSeller('evaluate','list');?>">
...
$(document).ready(function(){
    ...
    $('#btn_explain_submit').on('click', function() {
        if($('#explain_form').valid()){
            ...
            $.post("<?php echo urlSeller('evaluate', 'explain_save');?>",{
                geval_id: geval_id,
    ...
    $('#btn_explain_again_submit').on('click', function() {
        if($('#explain_again_form').valid()){
            ...
            $.post("<?php echo urlSeller('evaluate', 'explain_again_save');?>",{
                geval_id: geval_id,
