...
<div class="tabmenu">
  ...
  <a uri="<?php echo urlSeller('photos','album_add');?>" wt_type="dialog" dialog_title="<?php echo $lang['album_class_add'];?>" class="wtbtn wtbtn-mint" style="right: 100px;"><i class="icon-folder-open "></i><?php echo $lang['album_class_add'];?></a>
  ...
  <table class="search-form">
    <tbody>
      <tr>
        ...
        <td class="w100"><form name="select_sort" id="select_sort" class="sortord" action="<?php echo urlSeller('photos','cate');?>">
  ...
  <div class="wtsc-album">
    <ul>
      ...
      <li class="hidden">
        <dl>
          <dt>
            <div class="covers"><a href="<?php echo urlSeller('photos','album_pic_list',array('id'=>$v['ac_id']));?>">
              <?php if($v['ac_cover'] != ''){ ?>
              <img id="aclass_cover" src="<?php echo cthumb($v['ac_cover'], 240, $_SESSION['store_id']);?>">
              <?php }else{?>
              <i class="icon-camera-retro"></i>
              <?php }?>
              </a></div>
            <h3 class="title"><a href="<?php echo urlSeller('photos','album_pic_list',array('id'=>$v['aclass_id']));?>"><?php echo $v['ac_name'];?></a></h3>
          </dt>
          <dd class="date"><?php echo $lang['album_class_pic_altogether'];?><?php echo $v['count']?><?php echo $lang['album_class_pic_folio'];?></dd>
          <dd class="buttons"><span wt_type="dialog" dialog_title="<?php echo $lang['album_class_deit'];?>" dialog_id='album_<?php echo $v['ac_id'];?>' dialog_width="480" uri="<?php echo urlSeller('photos','album_edit',array('id'=>$v['ac_id']));?>"><a href="JavaScript:void(0);"><i class="icon-pencil"></i><?php echo $lang['album_class_edit'];?></a></span>
            <?php if($v['is_default'] != '1'){?>
            <a href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['album_class_delete_confirm_message'];?>', '<?php echo urlSeller('photos','album_del',array('id'=>$v['ac_id']));?>');"><i class="icon-remove-sign"></i><?php echo $lang['album_class_delete'];?></a>
            <?php }?>
          </dd>
        </dl>
      </li>
