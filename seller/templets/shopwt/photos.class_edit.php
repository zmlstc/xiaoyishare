...
<div class="eject_con">
  <div id="warning"></div>
  <form id="category_form" method="post" target="_parent" action="<?php echo urlSeller('photos','album_edit_save');?>">
    ...
    <dl>
      ...
      <dd>
        <textarea rows="3" class="textarea w300" name="description" id="description"><?php echo $output['class_info']['ac_des'];?></textarea>
      </dd>
    </dl>
    <dl>
