...
<div class="goods-gallery" wttype="gallery-<?php echo $output['color_id'];?>"> <a class="sample_demo" href="<?php echo urlSeller('album','pic_list',array('item'=>'goods_image','color_id'=>$output['color_id']));?>" style="display:none;"><?php echo $lang['wt_submit'];?></a>
