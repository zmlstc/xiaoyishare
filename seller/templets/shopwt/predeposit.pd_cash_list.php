...
<div class="wrap">
  <div class="tabmenu">
    ...
    <!--<a class="wtbtn wtbtn-mint" href="<?php echo urlShop('member_security','auth',array('type'=>'pd_cash'));?>"><i class="icon-money"></i>申请提现</a>-->
  </div>
  ...
  <form method="get" action="<?php echo urlShop('predeposit','pd_cash_list');?>">
  ...
  <table class="wtm-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td><p><a href="<?php echo urlSeller('predeposit_tx','pd_cash_info',array('id'=>$val['pdc_id']));?>"><?php echo $lang['wt_view']; ?></a></p></td>
      </tr>
      <?php } ?>
      <?php } else {?>
      <tr>
