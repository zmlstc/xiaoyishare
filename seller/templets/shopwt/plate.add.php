...
<div class="wtsc-form-default">
  <form method="post" action="<?php if (empty($output['plate_info'])) { echo urlSeller('plate', 'plate_add');} else { echo urlSeller('plate', 'plate_edit');}?>" id="plate_form">
    ...
    <input type="hidden" name="p_id" value="<?php echo $output['plate_info']['plate_id'];?>"/>
        ...
        <dl>
          ...
          <dd>
            ...
            <p class="hr8">
              <a class="wtbtn" wttype="show_desc" href="<?php echo urlSeller('album','pic_list',array('item'=>'des'));?>"><i class="icon-picture"></i>插入相册图片</a>
