...
<div class="wrap">
  <div class="tabmenu">
    ...
    <a href="<?php echo urlSeller('navigation', 'navigation_add');?>" class="wtbtn wtbtn-mint" title="添加导航">添加导航</a> </div>
  <table class="wtsc-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td class="nscs-table-handle"><span><a href="<?php echo urlSeller('navigation', 'navigation_edit', array('sn_id' => $value['sn_id']));?>" class="btn-bluejeans"><i class="icon-edit"></i>
...
<form id="del_form" method="post" action="<?php echo urlSeller('navigation', 'navigation_del');?>">
