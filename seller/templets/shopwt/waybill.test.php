...
.print-btn i { background: url(<?php echo SELLER_TEMPLATES_URL?>/images/seller/wtsc_bg_img.png)scroll no-repeat 0 -460px; vertical-align: middle; display: inline-block; width: 32px; height: 32px;}
