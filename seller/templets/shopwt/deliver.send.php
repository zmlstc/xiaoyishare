...
.sticky .tabmenu { padding: 0;  position: relative; }
        ...
        <span class="fr mr5"> <a href="<?php echo urlSeller('deliver', 'waybill_print', array('order_id' => $output['order_info']['order_id']));?>" class="wtbtn-mini" target="_blank" title="打印运单"/><i class="icon-print"></i>打印运单</a></span>
<div class="wrap">
  <div class="step-title"><em><?php echo $lang['store_deliver_first_step'];?></em><?php echo $lang['store_deliver_confirm_trade'];?></div>
  <form name="deliver_form" method="POST" id="deliver_form" action="<?php echo urlSeller('deliver','send',array('order_id'=>$_GET['order_id']));?>" onsubmit="ajaxpost('deliver_form', '', '', 'onerror');return false;">
    ...
    <table class="wtsc-default-table order deliver">
      <tbody>
        ...
        <tr>
          ...
          <a href="javascript:void(0)" wt_type="dialog" dialog_title="<?php echo $lang['store_deliver_buyer_adress'];?>" dialog_id="edit_buyer_address" uri="<?php echo urlSeller('deliver','buyer_address_edit',array('order_id'=>$output['order_info']['order_id']));?>" dialog_width="550" class="wtbtn-mini fr"><i class="icon-edit"></i><?php echo $lang['wt_edit'];?></a></td>
        </tr>
        <?php } else { ?>
        <tr>
    ...
    <div class="deliver-sell-info"><strong class="fl"><?php echo $lang['store_deliver_my_daddress'].$lang['wt_colon'];?></strong>
      <a href="javascript:void(0);" onclick="ajax_form('modfiy_daddress', '<?php echo $lang['store_deliver_select_daddress'];?>', '<?php echo urlSeller('deliver','send_address_select',array('order_id'=>$output['order_info']['order_id']));?>', 640,0);" class="wtbtn-mini fr"><i class="icon-edit"></i><?php echo $lang['wt_edit'];?></a> <span id="seller_address_span">
...
$(function(){
    ...
    $('#my_address_add').click(function(){
		ajax_form('my_address_add', '<?php echo $lang['store_deliver_add_daddress'];?>' , '<?php echo urlSeller('deliver','send_address_edit');?>', 550,0);
    });
});
</script>
