...
<div class="wtsc-flow-box" id="wtscComplainFlow">
  <div class="wtsc-flow-container">
    ...
    <div class="wtsc-form-default">
        ...
        <dd>
          <?php
                        if(empty($output['complain_info']['complain_pic1'])&&empty($output['complain_info']['complain_pic2'])&&empty($output['complain_info']['complain_pic3'])) {
                            ...
                            $pic_link = urlShop('show_pics','',array('type'=>'complain')).'?pics=';
      ...
      <form action="<?php echo urlSeller('complain','appeal_save');?>" method="post" id="add_form" enctype="multipart/form-data">
