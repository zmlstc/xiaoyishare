...
<div class="wtsc-form-default">
  <form method="post" action="<?php echo urlSeller('navigation','navigation_save');?>" target="_parent" name="store_navigation_form" id="store_navigation_form" enctype="multipart/form-data">
