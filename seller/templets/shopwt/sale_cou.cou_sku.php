  ...
  <table class="search-form">
    <tbody>
      <tr>
        ...
        <td class="tc w70"><a href="<?php echo urlSeller('sale_cou','cou_sku',array('cou_id'=>$output['cou_id']));?>" wttype="search_a" class="wts-btn"><i class="icon-search"></i><?php echo $lang['wt_search'];?></a></td>
        <td class="w10"></td>
      </tr>
    </tbody>
  </table>
