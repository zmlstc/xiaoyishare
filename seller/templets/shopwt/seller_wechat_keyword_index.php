...
<div class="wtsc-form-default">
	<script type="text/javascript" src="<?php echo STATIC_SITE_URL;?>/js/ajaxupload.js"></script>
	<script type="text/javascript" src="<?php echo STATIC_SITE_URL;?>/js/addkeyword.js" charset="utf-8"></script>
	<link rel="stylesheet" type="text/css" href="<?php echo SELLER_TEMPLATES_URL;?>/keyword/css/keyword.css" />
