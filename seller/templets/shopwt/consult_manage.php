...
<form method="get" action="<?php echo urlSeller('consult','consult_list');?>">
  ...
  <thead>
    ...
    <tr>
      ...
      <td colspan="20"><label for="all"><?php echo $lang['wt_select_all'];?></label>
        <a href="javascript:void(0);" class="wtbtn-mini" wt_type="batchbutton" uri="<?php echo urlSeller('consult','drop_consult');?>" name="id" confirm="<?php echo $lang['wt_ensure_del'];?>"><i class="icon-trash"></i><?php echo $lang['wt_del'];?></a></td>
    </tr>
    <?php }?>
  </thead>
  <tbody>
    ...
    <tr>
      <th colspan="20" class="tl"><input type="checkbox"  value="<?php echo $consult['consult_id'];?>" class="checkitem ml10 mr10" />
        <span><a href="<?php echo urlShop('goods','',array('goods_id'=>$consult['goods_id']));?>" target="_blank"><?php echo $consult['goods_name'];?></a></span><span class="ml20"><?php echo $lang['store_consult_list_consult_member'].$lang['wt_colon'];?></span>
    ...
    <tr>
      ...
      <td rowspan="2" class="nscs-table-handle vt"><?php if($consult['consult_reply'] == ''){?>
        <span><a href="javascript:void(0);" class="btn-aqua" wt_type="dialog" dialog_id="my_qa_reply" dialog_title="<?php echo $lang['store_consult_list_reply_consult'];?>" dialog_width="460" uri="<?php echo urlSeller('consult','reply_consult',array('id'=>$consult['consult_id']));?>"><i class="icon-comments-alt "></i><p><?php echo $lang['store_consult_list_reply'];?></p></a></span>
        <?php }else{?>
        <span><a href="javascript:void(0);" wt_type="dialog" dialog_id="my_qa_edit_reply" dialog_title="<?php echo $lang['store_consult_list_reply_consult'];?>" dialog_width="480" uri="<?php echo urlSeller('consult','reply_consult',array('id'=>$consult['consult_id']));?>" class="btn-bluejeans"><i class="icon-edit"></i><p><?php echo $lang['wt_edit'];?></p></a></span>
        <?php }?>
        <span><a href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['wt_ensure_del'];?>', '<?php echo urlSeller('consult','drop_consult',array('id'=>$consult['consult_id']));?>');" class="btn-grapefruit"><i class="icon-trash"></i><p><?php echo $lang['wt_del'];?></p></a> </span></td>
    </tr>
  ...
  <tfoot>
    ...
    <tr>
      ...
      <th colspan="20"><label for="all2"><?php echo $lang['wt_select_all'];?></label>
        <a href="javascript:void(0);" class="wtbtn-mini" wt_type="batchbutton" uri="<?php echo urlSeller('consult','drop_consult');?>" name="id" confirm="<?php echo $lang['wt_ensure_del'];?>"><i class="icon-trash"></i><?php echo $lang['wt_del'];?></a></th>
    </tr>
    <tr>
