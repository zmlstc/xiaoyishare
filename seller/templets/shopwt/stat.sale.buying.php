...
<form method="get" action="<?php echo urlSeller('stat_sale','buying');?>" target="_self">
...
<div class="alert alert-info"><strong>客单价分布</strong>（<a href="<?php echo urlSeller('stat_general','orderprange');?>" target="_blank">设置价格区间</a>）</div>
  ...
  <tbody>
	<tr id="row_0">
		<td class="tl">
    		...
    		<?php } else { ?>
    		<div class="tc h50 mt10">查看分布情况前，请先设置价格区间。<a href="<?php echo urlSeller('stat_general','orderprange');?>" target="_blank">马上设置</a></div>
    		<?php }?>
		</td>
	</tr>
  </tbody>
