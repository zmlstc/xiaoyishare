...
<div class="wtsc-form-default">
  ...
  <form id="add_form" action="<?php echo urlSeller('sale_bundling','bundling_quota_add');?>" method="post">
  <?php } else {?>
  <form id="add_form" action="<?php echo urlSeller('sale_bundling','bundling_renew');?>" method="post">
  <?php }?>
