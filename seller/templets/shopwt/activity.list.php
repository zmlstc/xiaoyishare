...
<table class="wtsc-default-table">
  ...
  <tbody>
    ...
    <tr>
      <td></td>
      <td class="tl"><a target="_blank" href="<?php echo urlShop('activity','',array('activity_id'=>$v['activity_id']));?>"><?php echo $v['activity_title']; ?></a></td>
      ...
      <td class="nscs-table-handle"><span><a id="a_<?php echo $v['activity_id'];?>" href="<?php echo urlSeller('activity','activity_apply',array('activity_id'=>$v['activity_id']));?>"  class="btn-mint"><i class="icon-edit"></i>
