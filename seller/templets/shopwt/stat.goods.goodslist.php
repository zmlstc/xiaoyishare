...
<form method="get" action="<?php echo urlSeller('stat_goods','goodslist');?>" target="_self" id="formSearch">
...
function getStatdata(gid){
	$('#goodsinfo_div').load('<?php echo urlSeller('stat_goods','goodsinfo');?>?gid='+gid);
}
</script>