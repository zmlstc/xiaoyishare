...
<div class="wtsc-form-default">
    ...
    <form id="add_form" action="<?php echo urlSeller('sale_xianshi','xianshi_save');?>" method="post">
    <?php } else { ?>
    <form id="add_form" action="<?php echo urlSeller('sale_xianshi','xianshi_edit_save');?>" method="post">
