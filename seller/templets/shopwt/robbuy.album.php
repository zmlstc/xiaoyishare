<div class="robbuy-gallery"> <a class='sample_demo' id="select_s" href="<?php echo urlSeller('album','pic_list',array('item'=>'robbuy'));?>" style="display:none;"><?php echo $lang['store_goods_batch_edit_submit'];?></a>
