...
<form method="get" action="<?php echo urlSeller('complain','index');?>">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td><?php
				...
				?></td>
      <td class="nscs-table-handle"><span><a href="<?php echo urlSeller('complain','complain_show',array('complain_id'=>$val['complain_id']));?>" class="btn-bittersweet"><i class="icon-eye-open"></i>
