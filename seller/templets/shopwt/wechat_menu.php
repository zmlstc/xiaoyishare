...
<style>.public{width:960px;margin:0 auto;padding:30px 0;overflow:hidden}.information{overflow:hidden;width:100%;padding-bottom:50px}.individual{width:620px;float:left}.information .info table{width:100%;border-collapse:collapse}.wrap_bottom{width:806px;height:2px;overflow:hidden;background:#E9E9E9;position:absolute;bottom:-3px}.eject_btn{width:137px;height:32px;line-height:32px;background:url(<?php echo SELLER_TEMPLATES_URL;?>/keyword/images/member/btn.gif) 0 -198px;position:absolute;top:10px;right:20px;z-index:3}.eject_btn b{display:block;width:97px;height:32px;padding-left:40px;color:#3e3e3c;font-size:14px;cursor:pointer}.eject_btn .ico1{background:url(<?php echo SELLER_TEMPLATES_URL;?>/keyword/images/member/ico.gif) no-repeat 15px -656px}.eject_btn .ico2{background:url(<?php echo SELLER_TEMPLATES_URL;?>/keyword/images/member/ico.gif) no-repeat 15px -188px}.eject_btn .ico3{background:url(<?php echo SELLER_TEMPLATES_URL;?>/keyword/images/member/ico.gif) no-repeat 12px -943px}.eject_btn_two{width:137px;height:32px;line-height:32px;background:url(<?php echo SELLER_TEMPLATES_URL;?>/keyword/images/member/btn.gif) 0 -198px}.eject_pos1{position:absolute;top:10px;right:20px;z-index:3}.eject_pos2{position:absolute;top:10px;right:170px;z-index:3}.eject_pos3{top:10px;left:0;z-index:3;float:left}.eject_pos4{position:absolute;top:10px;right:130px;z-index:3}.eject_btn_two b{display:block;height:32px;color:#3e3e3c;font-size:14px;cursor:pointer}.eject_btn_two .ico1{width:107px;padding-left:30px;background:url(<?php echo SELLER_TEMPLATES_URL;?>/keyword/images/member/ico.gif) no-repeat 15px -1330px}.eject_btn_two .ico2{width:97px;padding-left:40px;background:url(<?php echo SELLER_TEMPLATES_URL;?>/keyword/images/member/ico.gif) no-repeat 15px -1282px}.eject_btn_two .ico3{width:87px;padding-left:50px;background:url(<?php echo SELLER_TEMPLATES_URL;?>/keyword/images/member/ico.gif) no-repeat 22px -1416px}.eject_btn_two .ico4{width:102px;padding-left:35px;background:url(<?php echo SELLER_TEMPLATES_URL;?>/keyword/images/member/ico.gif) no-repeat 12px -1710px}.eject_btn .ico5{width:102px;padding-left:35px;background:url(<?php echo SELLER_TEMPLATES_URL;?>/keyword/images/member/ico.gif) no-repeat 15px -656px}.eject_btn_three{width:97px;height:32px;line-height:32px;background:url(<?php echo SELLER_TEMPLATES_URL;?>/keyword/images/member/btn.gif) 0 -880px}.eject_btn_three b{display:block;height:32px;color:#3e3e3c;font-size:14px;cursor:pointer}.eject_btn_three .ico3{padding-left:40px;background:url(<?php echo SELLER_TEMPLATES_URL;?>/keyword/images/member/ico.gif) no-repeat 22px -1330px}.eject_btn_three .ico4{padding-left:40px;background:url(<?php echo SELLER_TEMPLATES_URL;?>/keyword/images/member/ico.gif) no-repeat 22px -1374px}.clear{clear:both;height:0}.align1{text-align:left}.align2{text-align:center}.align3{vertical-align:top;padding-top:15px}.align4{text-align:right;padding-right:30px}.width1{width:30px}.width2{width:80px}.width3{width:170px}.width4{width:60px}.width5{width:180px}.width6{width:600px}.width7{width:300px}.width8{width:140px}.width9{width:400px}.width10{width:270px}.width11{width:200px}.width12{width:430px}.width13{width:120px}.width14{width:210px}.width15{width:50px}.width16{width:460px}.width17{width:556px}.table table{width:100%;border-collapse:collapse}.table .line_bold{background:url(<?php echo SELLER_TEMPLATES_URL;?>/keyword/images/member/line_bold.gif) repeat-x 0 bottom}.table th{font-weight:400;height:32px}.public .gray th{color:#919191}.public .gray th{color:#919191}#treet1{background-color:#fff}.table .last_line td{border-bottom:0}.table .line td{border-top:1px solid #E2E2E2;border-bottom:1px solid #E2E2E2}.table td{padding-top:10px;padding-bottom:10px}.padding5{padding-left:71px}.table .line_bold{background:url(<?php echo SELLER_TEMPLATES_URL;?>/keyword/images/member/line_bold.gif) repeat-x 0 bottom}.right_ico{display:block;width:10px;height:10px;overflow:hidden;background:url(<?php echo SELLER_TEMPLATES_URL;?>/keyword/images/member/ico.gif) no-repeat 0 -1215px;cursor:pointer}table .add1_ico{float:left;padding-left:23px;color:#919191;background:url(<?php echo SELLER_TEMPLATES_URL;?>/keyword/images/member/ico.gif) no-repeat 10px -1180px}.table .edit1{float:left;padding-left:23px;color:#919191;background:url(<?php echo SELLER_TEMPLATES_URL;?>/keyword/images/member/ico.gif) no-repeat 10px -729px}.table .delete{float:left;padding-left:25px;color:#919191;background:url(<?php echo SELLER_TEMPLATES_URL;?>/keyword/images/member/ico.gif) no-repeat 10px -633px}.individual{width:620px;float:left}.information .info th{font-weight:400;text-align:left;color:#666;padding-right:20px;height:40px}.biz_pub_btn,.biz_pub_btn:hover{margin-right:10px ;background-color: #48CFAE;width:190px;height:30px;display:inline-block;line-height:30px;text-align:center;color:#fff;font-weight:bolder;text-decoration:none;border:0}</style>
...
$(function()
{
    ...
    var path = "<?php echo SELLER_TEMPLATES_URL;?>/keyword/images/";
    if (map.length > 0)
    {
...
<div class="tabmenu"><?php include template('layout/submenu');?><a class="wtbtn wtbtn-mint" ectype="dialog" dialog_title="新增分类" dialog_id="my_category_add" dialog_width="480" uri="<?php echo urlSeller('wechat_menu','add');?>"><i class="icon-plus-sign"></i>添加分类</a></div> 
