...
<?php if ($output['isOwnShop']) { ?>
  <a class="wtbtn wtbtn-mint" href="<?php echo urlSeller('sale_mansong', 'mansong_add');?>"><i class="icon-plus-sign"></i><?php echo $lang['mansong_add'];?></a>

<?php } else { ?>

  <?php if(!empty($output['current_mansong_quota'])) { ?>
  <a class="wtbtn wtbtn-mint" style="right:100px" href="<?php echo urlSeller('sale_mansong', 'mansong_add');?>"><i class="icon-plus-sign"></i><?php echo $lang['mansong_add'];?></a> <a class="wtbtn wtbtn-aqua" href="<?php echo urlSeller('sale_mansong', 'mansong_quota_add');?>" title=""><i class="icon-money"></i>套餐续费</a>
  <?php } else { ?>
  <a class="wtbtn wtbtn-aqua" href="<?php echo urlSeller('sale_mansong', 'mansong_quota_add');?>" title=""><i class="icon-money"></i>购买套餐</a>
  <?php } ?>
<?php } ?>
...
<form method="get" action="<?php echo urlSeller('sale_mansong','mansong_list');?>">
...
<table class="wtsc-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle"><span><a href="<?php echo urlSeller('sale_mansong','mansong_detail',array('mansong_id'=>$val['mansong_id']));?>" class="btn-bluejeans"><i class="icon-th-list"></i>
    ...
    $(document).ready(function(){
        $('[wttype="btn_mansong_del"]').on('click', function() {
            if(confirm('<?php echo $lang['wt_ensure_cancel'];?>')) {
                var action = "<?php echo urlSeller('sale_mansong', 'mansong_del');?>";
