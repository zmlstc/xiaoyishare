...
<div class="eject_con">
  <div class="adds">
    <div id="warning"></div>
    <form method="post" action="<?php echo urlSeller('deliver','buyer_address',array('order_id'=>$_GET['order_id']));?>" id="address_form" target="_parent">
...
$(document).ready(function(){
	...
	$('#submit').on('click',function(){
		if ($('#address_form').valid()) {
            ...
            $.post(
            "<?php echo urlSeller('deliver', 'buyer_address_save');?>", 
            {
