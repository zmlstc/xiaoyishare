...
<div class="tabmenu">
  ...
  <a class="wtbtn wtbtn-mint" href="<?php echo urlSeller('transport','add',array('type'=>$_GET['type']));?>"><?php echo $lang['transport_tpl_add'];?> </a> </div>
<!---------begin------------------------>
...
$(function(){	
	$('a[class="J_Delete wtbtn-mini"]').click(function(){
		...
		get_confirm('<?php echo $lang['transport_del_confirm'];?>','<?php echo urlSeller('transport','delete',array('type'=>$_GET['type']));?>?id='+id);
	...
	$('a[class="J_Modify wtbtn-mini"]').click(function(){
		var id = $(this).attr('data-id');
		if(typeof(id) == 'undefined') return false;
		$(this).attr('href','<?php echo urlSeller('transport','edit',array('type'=>$_GET['type']));?>?id='+id);
		return true;
	});
	...
	$('a[class="J_Clone wtbtn-mini"]').click(function(){
		var id = $(this).attr('data-id');
		if(typeof(id) == 'undefined') return false;
		$(this).attr('href','<?php echo urlSeller('transport','clone',array('type'=>$_GET['type']));?>?id='+id);
		return true;
	});
