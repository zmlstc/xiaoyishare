...
<form method="get" action="<?php echo urlSeller('vr_bill','index');?>" target="_self">
...
<table class="wtsc-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td><a href="<?php echo urlSeller('vr_bill','show_bill',array('ob_id'=>$bill_info['ob_id']));?>"><?php echo $lang['wt_view'];?></a></td>
    </tr>
    <?php }?>
    <?php } else { ?>
    <tr>
