...
<form method="get" action="<?php echo urlSeller('stat_sale','sale');?>" target="_self">
...
<script type="text/javascript" src="<?php echo SELLER_TEMPLATES_URL; ?>/js/ui.core.js"></script>
<script type="text/javascript" src="<?php echo SELLER_TEMPLATES_URL; ?>/js/ui.tabs.js"></script>
...
$(function(){
	...
	$("[name='searchweek_month']").change(function(){
		...
		$.getJSON('<?php echo urlShop('index','getweekofmonth');?>',{y:year,m:month},function(data){
	        if(data != null){
	...
	$('#statlist').load('<?php echo urlSeller('stat_sale','salelist',array('c'=>$output['searchtime'],'order_type'=>$_REQUEST['order_type']));?>');
});
</script>