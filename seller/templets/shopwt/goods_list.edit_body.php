...
<head>
<script>
var SITEURL = '<?php echo BASE_SITE_URL;?>'; var SHOP_TEMPLATES_URL = '<?php echo SELLER_TEMPLATES_URL?>';
</script>
...
<div class="eject_con">
  ...
  <form method="post" action="<?php echo urlSeller('goods_online', 'edit_body_ajax');?>" onsubmit="ajaxpost('body_form', '', '', 'onerror')" id="body_form">
