...
<div class="wtsc-form-default">
  <form id="add_form" action="<?php if ($output['menu_key'] == 'book_quota_add') {echo urlSeller('sale_book', 'book_quota_add');} else {echo urlSeller('sale_book', 'book_renew');}?>" method="post">
