...
<div class="wtsc-form-default">
  <form id="add_form" action="<?php echo urlSeller('sale_cou','cou_edit_save');?>" method="post">
...
<?php } ?>
        ...
        <a id="cou-sku-choose-btn" href="<?php echo urlSeller('sale_cou','cou_sku',array('cou_id'=>$info['id']));?>" class="wtbtn wtbtn-aqua">选择活动商品</a>
...
$(function() {
    ...
    var couLevelSkuChooseTriggered = function(id, url) {
        $("[data-cou-level-sku-choose-container='"+id+"']").load(
            url || '<?php echo urlSeller('sale_cou','cou_level_sku');?>?level='+id,
            function() {
