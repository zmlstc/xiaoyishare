...
<div class="wtsc-form-default">
  <form id="add_form" action="<?php if ($output['menu_key'] == 'combo_quota_add') {echo urlSeller('sale_combo', 'combo_quota_add');} else {echo urlSeller('sale_combo', 'combo_renew');}?>" method="post">
