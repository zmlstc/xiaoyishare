  ...
  <div class="wtsc-album">
    <ul>
      ...
      <li class="hidden">
        <dl>
          <dt>
            <div class="covers"><a href="<?php echo urlSeller('video','album_video_list',array('id'=>$v['video_class_id']));?>">
              <i class=" icon-facetime-video"></i>
              </a></div>
            <h3 class="title"><a href="<?php echo urlSeller('video','album_video_list',array('id'=>$v['video_class_id']));?>"><?php echo $v['video_class_name'];?></a></h3>
          </dt>
