...
<style type="text/css">
  ...
  #focus .pre { left: 0; background: url(<?php echo SELLER_TEMPLATES_URL;?>/images/member/gallery-prev.png) no-repeat left center; }
  #focus .next { right: 0; background: url(<?php echo SELLER_TEMPLATES_URL;?>/images/member/gallery-next.png) no-repeat right center; }
...
<div id="pictureFolder" class="wtsc-picture-folder">
  <dl class="wtsc-album-intro">
    <dt class="albume-name"><a href="<?php echo urlSeller('video','album_video_list',array('id'=>$output['class_info']['video_class_id']));?>"><?php echo $output['class_info']['video_class_name']?></a></dt>
...
function ajax_change_videomessage(url){
	$.getJSON("<?php echo urlSeller('video','ajax_change_videomessage');?>", {'url':url}, function(data){
