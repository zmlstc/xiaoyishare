...
<div class="eject_con">
  <div id="warning"></div>
  <form method="post" id="order_cancel_form" onsubmit="ajaxpost('order_cancel_form', '', '', 'onerror');return false;" action="<?php echo urlSeller('order_vr','change_state',array('state_type'=>'order_cancel','order_id'=>$output['order_id']));?>">
