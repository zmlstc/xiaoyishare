...
<div class="wtsc-form-default">
  <form id="add_form" action="<?php echo urlSeller('account', 'account_save');?>" method="post">
    <dl>
...
$(document).ready(function(){
    jQuery.validator.addMethod("seller_name_exist", function(value, element, params) { 
        ...
        $.ajax({  
            type:"GET",  
            url:'<?php echo urlSeller('account', 'check_seller_name_exist');?>',  
            async:false,  
    ...
    jQuery.validator.addMethod("check_member_password", function(value, element, params) { 
        ...
        $.ajax({  
            type:"GET",  
            url:'<?php echo urlSeller('account', 'check_seller_member');?>',  
            async:false,  
