...
<link href="<?php echo SELLER_TEMPLATES_URL?>/css/shop_custom.css" rel="stylesheet" type="text/css">
<link href="<?php echo SELLER_TEMPLATES_URL?>/css/shop_store_mb.css" rel="stylesheet" type="text/css">
<div class="page"> 
  <!-- 页面导航 -->
  <div class="fixed-bar">
      ...
      <div id="item_list" class="item-list">
        ...
        <div wttype="special_item" class="special-item <?php echo $value['item_type'];?> <?php echo $value['usable_class'];?>" data-item-id="<?php echo $value['item_id'];?>">
          ...
          <div id="item_edit_content">
            <?php require('mb.item_' . $value['item_type'] . '.php');?>
          </div>
...
<script type="text/javascript">
    ...
    var url_item_add = "<?php echo urlSeller('mb_decoration', 'special_item_add');?>";
    var url_item_del = "<?php echo urlSeller('mb_decoration', 'special_item_del');?>";
    var url_item_edit = "<?php echo urlSeller('mb_decoration', 'special_item_edit');?>";
    $(document).ready(function(){
        ...
        var update_item_sort = function() {
            ...
            $.post("<?php echo urlSeller('mb_decoration','update_item_sort');?>", {special_id: special_id, item_id_string: item_id_string}, function(data) {
                if(typeof data.error != 'undefined') {
        ...
        $('#item_list').on('click', '[wttype="btn_usable"]', function() {
            ...
            $.post("<?php echo urlSeller('mb_decoration','update_item_usable');?>", {item_id: item_id, usable: usable, special_id: special_id}, function(data) {
                if(typeof data.error != 'undefined') {
                    showError(data.message);
                }
            }, 'json');
