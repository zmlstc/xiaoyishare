...
<?php if ($output['isOwnShop']) { ?>
  <a href="<?php echo urlSeller('robbuy', 'robbuy_add_vr'); ?>" style="right:100px" class="wtbtn wtbtn-mint" title="新增虚拟商品抢购"><i class="icon-plus-sign"></i>新增虚拟抢购</a>
  <a href="<?php echo urlSeller('robbuy', 'robbuy_add');?>" class="wtbtn wtbtn-mint" title="<?php echo $lang['robbuy_index_new_group'];?>"><i class="icon-plus-sign"></i><?php echo $lang['robbuy_index_new_group'];?></a>
<?php } else { ?>

  <?php if(!empty($output['current_robbuy_quota'])) { ?>
  <a href="<?php echo urlSeller('robbuy', 'robbuy_add_vr'); ?>" style="right:200px" class="wtbtn wtbtn-mint" title="新增虚拟商品抢购"><i class="icon-plus-sign"></i>新增虚拟抢购</a>
  <a href="<?php echo urlSeller('robbuy', 'robbuy_add');?>" style="right:100px" class="wtbtn wtbtn-mint" title="<?php echo $lang['robbuy_index_new_group'];?>"><i class="icon-plus-sign"></i><?php echo $lang['robbuy_index_new_group'];?></a>
  <a class="wtbtn wtbtn-aqua" href="<?php echo urlSeller('robbuy', 'robbuy_quota_add');?>" title="套餐续费"><i class="icon-money"></i>套餐续费</a>
  <?php } else { ?>
  <a class="wtbtn wtbtn-aqua" href="<?php echo urlSeller('robbuy', 'robbuy_quota_add');?>" title="购买套餐"><i class="icon-money"></i>购买套餐</a>
  <?php } ?>
<?php } ?>
...
<table class="search-form">
  <form method="get" action="<?php echo urlSeller('robbuy','index');?>">
