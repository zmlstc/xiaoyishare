...
<div class="wtsc-form-default">
  <form id="form_setting" method="post" action="<?php echo urlSeller('mb_decoration', 'decoration_setting_save');?>">
    <dl>
    ...
    <dl>
      ...
      <dd> <a href="<?php echo urlSeller('mb_decoration', 'decoration_edit', array('decoration_id' => $output['decoration_id']));?>" class="wtbtn wtbtn-aqua mr5" target="_blank"><i class="icon-puzzle-piece"></i>装修页面</a>
