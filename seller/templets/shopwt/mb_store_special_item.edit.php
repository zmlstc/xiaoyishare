...
<div class="page"> 
  ...
  <form id="form_item" action="<?php echo urlSeller('mb_decoration', 'special_item_save');?>" method="post">
    ...
    <div id="item_edit_content" class="mb-item-edit-content">
      <?php require('mb.item_' . $output['item_info']['item_type'] . '.php');?>
    </div>
...
<script type="text/javascript">
    ...
    var url_upload_image = '<?php echo urlSeller('mb_decoration', 'special_image_upload');?>';
