...
<div class="robbuy-gallery" wttype="store_sns_album"> <a class="sample_demo" id="select_s" href="<?php echo urlSeller('album','pic_list',array('item'=>'store_sns_normal'));?>" style="display:none;"><?php echo $lang['wt_submit'];?></a>
