...
<form method="get" action="<?php echo urlSeller('lib_goods','index');?>">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="nscs-table-handle">
        <span><a href="javascript:void(0)" class="btn-mint" wt_type="dialog" dialog_title="认领商品：<?php echo str_cut($val['goods_name'],50); ?>" dialog_id="map_edit" dialog_width="480" uri="<?php echo urlSeller('lib_goods','edit_goods',array('gc_id'=>$val['gc_id'],'goods_id'=>$val['goods_id']));?>" href="" class="btn-bluejeans"><i class="icon-edit"></i>
        <p>认领</p>
        </a></span></td>
    </tr>
    <?php } ?>
...
function gcategoryChange(){
    ...
    if (this.value > 0){
        var _self = this;
        var url = '<?php echo urlSeller('lib_goods','ajax_goods_class');?>';
