...
<div class="wtsc-form-default">
    ...
    <form id="add_form" action="<?php echo urlSeller('sale_pingou','pingou_save');?>" method="post">
    <?php } else { ?>
    <form id="add_form" action="<?php urlSeller('sale_pingou','pingou_edit_save');?>" method="post">
