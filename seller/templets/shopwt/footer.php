...
document.getElementById('task').innerHTML='<iframe src="<?php echo BASE_SITE_URL;?>/system/task/cj_index.php/task/index/run/js" width="0" height="0" frameborder="0" style="display:none;"></iframe>';
</script>
<?php }?>
