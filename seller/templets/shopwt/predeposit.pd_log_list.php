...
<div class="wrap">
  <div class="tabmenu">
    ...
    <!--<a class="wtbtn wtbtn-bittersweet" title="在线充值" href="<?php echo urlShop('predeposit','recharge_add');?>" style="right: 207px;"><i class="icon-shield"></i>在线充值</a> <a class="wtbtn wtbtn-mint" href="<?php echo urlShop('member_security','auth',array('type'=>'pd_cash'));?>" style="right: 107px;"><i class="icon-money"></i>申请提现</a> <a class="wtbtn wtbtn-bluejeansjeans" href="<?php echo urlShop('predeposit','rechargecard_add');?>"><i class="icon-shield"></i>充值卡充值</a> </div>-->
