...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#btn_search_goods').on('click', function() {
            var url = "<?php echo urlSeller('sale_xianshi', 'goods_select');?>";
        ...
        $('#div_goods_search_result').on('click', '#btn_submit', function() {
            ...
            if(!isNaN(xianshi_price) && xianshi_price > 0 && xianshi_price < goods_price) {
                $.post('<?php echo urlSeller('sale_xianshi', 'xianshi_goods_add');?>', 
        ...
        $('#btn_edit_xianshi_goods_submit').on('click', function() {
            ...
            if(!isNaN(xianshi_price) && xianshi_price > 0 && xianshi_price < goods_price) {
                $.post('<?php echo urlSeller('sale_xianshi', 'xianshi_goods_price_edit');?>',
        ...
        $('#xianshi_goods_list').on('click', '[wttype="btn_del_xianshi_goods"]', function() {
            ...
            if(confirm('确认删除？')) {
                var xianshi_goods_id = $(this).attr('data-xianshi-goods-id');
                $.post('<?php echo urlSeller('sale_xianshi', 'xianshi_goods_delete');?>',
...
<div class="bottom">
  <label class="submit-border"><input type="submit" class="submit" id="submit_back" value="<?php echo $lang['wt_back'].$lang['xianshi_index'];?>" onclick="window.location='<?php echo urlSeller('sale_xianshi','xianshi_list');?>'"></label>
</div>
