...
<?php } ?>
<form action="<?php echo urlSeller('complain','apply_handle');?>" method="post" id="handle_form">
...
function get_complain_talk() {
    ...
    $.ajax({
        type:'POST',
        url:'<?php echo urlSeller('complain','get_complain_talk');?>',
        cache:false,
...
function publish_complain_talk() {
        $.ajax({
            type:'POST',
                url:'<?php echo urlSeller('complain','publish_complain_talk');?>',
                cache:false,
