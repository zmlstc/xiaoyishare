<div class="eject_con">
  ...
  <form method="post" target="_parent" action="<?php if ($output['brand_array']['brand_id']!='') echo urlSeller('brand','brand_edit'); else echo urlSeller('brand','brand_save'); ?>"enctype="multipart/form-data" id="brand_apply_form">
