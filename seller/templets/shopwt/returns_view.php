...
<div class="wtsc-flow-box">
  ...
  <?php require template('refund_right');?>
</div>
...
$(function(){
	$.getJSON('<?php echo urlSeller('index','get_express',array('e_code'=>$output['e_code'],'shipping_code'=>$output['return']['invoice_no'],'c'=>random(7)));?>',function(data){
		if(data){
