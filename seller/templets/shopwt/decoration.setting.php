...
<div class="wtsc-form-default">
  <form id="form_setting" method="post" action="<?php echo urlSeller('decoration', 'decoration_setting_save');?>">
    <dl>
      ...
      <dd>
        ...
        <p class="hint">选择是否使用店铺装修模板；<br/>
          ...
          如选择“否”根据 <a href="<?php echo urlSeller('setting','theme');?>">“店铺主题”</a> 所选中的系统预设值风格进行显示。</p>
      </dd>
    </dl>
    <dl>
...
<?php } ?>
    <dl>
      ...
      <dd> <a href="<?php echo urlSeller('decoration', 'decoration_edit', array('decoration_id' => $output['decoration_id']));?>" class="wtbtn wtbtn-aqua mr5" target="_blank"><i class="icon-puzzle-piece"></i>装修页面</a> <a id="btn_build" href="<?php echo urlSeller('decoration', 'decoration_build', array('decoration_id' => $output['decoration_id']));?>" class="wtbtn wtbtn-bittersweet" target="_blank"><i class="icon-magic"></i>生成页面</a>
