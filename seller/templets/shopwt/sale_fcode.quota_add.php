...
<div class="wtsc-form-default">
  <form id="add_form" action="<?php if ($output['menu_key'] == 'fcode_quota_add') {echo urlSeller('sale_fcode', 'fcode_quota_add');} else {echo urlSeller('sale_fcode', 'fcode_renew');}?>" method="post">
