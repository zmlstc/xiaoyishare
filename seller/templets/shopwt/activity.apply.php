...
<form method="GET" action="<?php echo urlSeller('store','activity_apply');?>">
  ...
  <table class="wtsc-default-table" >
    ...
    <tbody>
      ...
      <tr class="bd-line">
        <td><div class="pic-thumb"><a href="<?php echo urlShop('goods','',array('goods_id'=>$v['goods_id']));?>" target="_blank"><img src="<?php echo cthumb($v['goods_image'], 60,$_SESSION['store_id']);?>"></a></div></td>
  ...
  <div class="div-goods-select">
    <form method="GET" action="<?php echo urlSeller('activity','activity_apply');?>">
    ...
    <form method="POST" id="apply_form" onsubmit="ajaxpost('apply_form','','','onerror');" action="<?php echo urlSeller('activity','activity_apply_save');?>">
      <input type="hidden" name="activity_id" value="<?php echo $_GET['activity_id'];?>"/>
