...
<div class="goods-gallery add-step2"><a class='sample_demo' id="select_submit" href="<?php echo urlSeller('album','pic_list',array('item'=>'goods'));?>" style="display:none;"><?php echo $lang['wt_submit'];?></a>
...
$(function(){
    ...
    $('#jumpMenu').change(function(){
        $('[wttype="mea_img"]').load('<?php echo urlSeller('album','pic_list',array('item'=>'mobile'));?>?id=' + $(this).val()+'<?php if ($output['type'] == 'replace') {?>&type=replace<?php }?>');
    });
});
</script>