...
<?php if ($output['isOwnShop']) { ?>
  <a class="wtbtn wtbtn-mint"  href="<?php echo urlSeller('sale_bundling','bundling_add');?>" ><i class="icon-plus-sign"></i><?php echo $lang['bundling_add'];?></a>

<?php } else { ?>

  <?php if (empty($output['bundling_quota'])) { ?>
  <a href="javascript:void(0)" class="wtbtn wtbtn-aqua" onclick="go('<?php echo urlSeller('sale_bundling','bundling_quota_add');?>');" title="<?php echo $lang['bundling_quota_add'];?>"><i class="icon-money"></i><?php echo $lang['bundling_quota_add'];?></a>
  ...
  <a class="wtbtn wtbtn-mint"  href="<?php echo urlSeller('sale_bundling','bundling_add');?>" style="right:100px"><i class="icon-plus-sign"></i><?php echo $lang['bundling_add'];?></a>
  <?php }?>
  <a class="wtbtn wtbtn wtbtn-aqua" href="<?php echo urlSeller('sale_bundling','bundling_renew');?>"><i class="icon-money"></i>套餐续费</a>
  <?php } ?>
<?php } ?>
...
<?php } ?>
<form method="get" action="<?php echo urlSeller('sale_bundling','bundling_list');?>">
...
<table class="wtsc-default-table">
  <thead>
    ...
    <tr>
      ...
      <td colspan="20"><label for="all" ><?php echo $lang['wt_select_all'];?></label>
        <a href="javascript:void(0);" class="wtbtn-mini" wt_type="batchbutton" uri="<?php echo urlSeller('sale_bundling','drop_bundling');?>" name="bundling_id" confirm="<?php echo $lang['wt_ensure_del'];?>"><i class="icon-trash"></i><?php echo $lang['wt_del'];?></a></td>
    </tr>
  </thead>
  ...
  <tbody>
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle"><span><a href="<?php echo urlSeller('sale_bundling','bundling_add',array('bundling_id'=>$val['bl_id']));?>" class="btn-bluejeans"><i class="icon-cog"></i>
        <p><?php echo $lang['bundling_edit'];?></p>
        </a></span> <span><a class="btn-grapefruit" href='javascript:void(0);' onclick="ajax_get_confirm('<?php echo $lang['wt_ensure_del'];?>', '<?php echo urlSeller('sale_bundling', 'drop_bundling', array('bundling_id' => $val['bl_id']));?>');"><i class="icon-trash"></i>
  ...
  <tfoot>
    <tr>
      ...
      <th colspan="20"><label for="all" ><?php echo $lang['wt_select_all'];?></label>
        <a href="javascript:void(0);" class="wtbtn-mini" wt_type="batchbutton" uri="<?php echo urlSeller('sale_bundling','drop_bundling');?>" name="bundling_id" confirm="<?php echo $lang['wt_ensure_del'];?>"><i class="icon-trash"></i><?php echo $lang['wt_del'];?></a></th>
    </tr>
    <tr>
