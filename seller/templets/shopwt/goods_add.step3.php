...
<?php }?>
<form method="post" id="goods_image" action="<?php if ($output['edit_goods_sign']) { echo urlSeller('goods_online', 'edit_save_image'); } else { echo urlSeller('goods_add', 'save_image');}?>">
    ...
    <div class="container">
      ...
      <div class="wtsc-goodspic-list">
        ...
        <div class="wtsc-select-album">
          <a class="wtbtn" href="<?php echo urlSeller('album','pic_list',array('item'=>'goods_image','color_id'=>$value['sp_value_id']));?>" wttype="select-<?php echo $value['sp_value_id'];?>"><i class="icon-picture"></i>从图片空间选择</a>
