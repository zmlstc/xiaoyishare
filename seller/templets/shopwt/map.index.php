...
<div class="tabmenu">
  ...
  <a class="wtbtn wtbtn-mint" wt_type="dialog" dialog_title="添加地址" dialog_id="add_map" dialog_width="480" uri="<?php echo urlSeller('map', 'add_map');?>"><i class="icon-plus-sign"></i>添加地址</a>
  <?php } ?>
</div>
...
<script type="text/javascript">
	...
	function getMarkerPoint(e){//拖拽结束时通过点找到地区
	    ...
	    getPointArea(point,function(pointArea){
    		...
    		$.ajax({
    			type: "POST",
    			url: '<?php echo urlSeller('map','update_map');?>',
    			data: obj,
    			async: false,
    		    success: function(rs){
    		    }
