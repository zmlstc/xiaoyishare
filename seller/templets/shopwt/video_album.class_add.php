...
<div class="eject_con">
  ...
  <form id="category_form" method="post" target="_parent" action="<?php echo urlSeller('video','album_add_save');?>">
    ...
    $('#category_form').validate({
        ...
        rules : {
        	name : {
                ...
                maxlength	: 20,
                remote   : {
                    url :'<?php echo urlSeller('video','ajax_check_class_name',array('column'=>'ok'));?>',
                    type:'get',
                    data:{
                        ac_name : function(){
                            return $('#name').val();
