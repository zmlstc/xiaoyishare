<?php defined('ShopWT') or exit('Access Denied By ShopWT');?>
  <form method="get" id="formSearch" action="<?php echo urlSeller('bill','show_bill');?>">
...
<table class="wtsc-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td>
       	<a target="_blank" href="<?php echo urlSeller('order','show_order',array('order_id'=>$order_info['order_id']));?>"><?php echo $lang['wt_view'];?></a>
        </td>
      </tr>
      <?php } ?>
      <?php } else { ?>
