...
<?php if ($output['isOwnShop']) { ?>
  <a class="wtbtn wtbtn-mint" href="<?php echo urlSeller('sale_cou', 'cou_add');?>"><i class="icon-plus-sign"></i>添加活动</a>

<?php } else { ?>

  <?php if(!empty($output['current_cou_quota'])) { ?>
  <a class="wtbtn wtbtn-mint" style="right:100px" href="<?php echo urlSeller('sale_cou', 'cou_add');?>"><i class="icon-plus-sign"></i>添加活动</a> <a class="wtbtn wtbtn-aqua" href="<?php echo urlSeller('sale_cou', 'cou_quota_add');?>" title=""><i class="icon-money"></i>套餐续费</a>
  <?php } else { ?>
  <a class="wtbtn wtbtn-aqua" href="<?php echo urlSeller('sale_cou', 'cou_quota_add');?>" title=""><i class="icon-money"></i>购买套餐</a>
  <?php } ?>
...
<form method="get" action="<?php echo urlSeller('sale_cou','cou_list');?>">
  ...
  <tbody id="cou_list">
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle tr">
          ...
          <span>
              <a href="<?php echo urlSeller('sale_cou','cou_edit',array('cou_id'=>$val['id']));?>" class="btn-bluejeans">
                  <i class="icon-edit"></i>
    ...
    $(document).ready(function(){
        $('[wttype="btn_del_cou"]').on('click', function() {
            if(confirm('<?php echo $lang['wt_ensure_del'];?>')) {
                var action = "<?php echo urlSeller('sale_cou', 'cou_del');?>";
