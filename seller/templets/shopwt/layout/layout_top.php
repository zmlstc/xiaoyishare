      ...
      <form id="login_form" method="post" action="<?php echo urlLogin('login', 'login');?>" onsubmit="ajaxpost('login_form', '', '', 'onerror')">
        ...
        <dl>
          ...
          <dd>
            ...
            <img src="" name="codeimage" border="0" id="codeimage" title="更换验证码" onclick="javascript:document.getElementById('codeimage').src='<?php echo urlShop('vercode','',array('type'=>'30x92'));?>?c=' + Math.random();" class="vt">
            <label></label>
          </dd>
        </dl>
        <?php } ?>
            <div class="bottom">
              ...
              <a class="sina" href="<?php echo urlMember('connect_sina'); ?>" title="新浪微博账号登录"><i></i></a>
              <?php } ?>
              <?php if (C('qq_isuse') == 1){?>
              <a class="qq" href="<?php echo urlMember('connect_qq'); ?>" title="QQ账号登录"><i></i></a>
              <?php } ?>
				</span>
              <?php } ?>
  ...
  <div class="topbar wrapper">
    ...
    <div class="right-menu">
      ...
      <dl>
        ...
        <dd>
          <ul>
		    <li><a href="<?php echo urlShop('show_joinin');?>" title="<?php echo $lang['wt_enter'];?>"><?php echo $lang['wt_enter'];?></a></li>
            <li><a href="<?php echo urlShop('login','show_login');?>" target="_blank" title="<?php echo $lang['wt_account'];?>"><?php echo $lang['wt_account'];?></a></li>
          </ul>
	 </dd>
      </dl>
      <?php
    ...
    <div class="user-entry">
      ...
      <?php }?>
      <span><a href="<?php echo urlShop('invite');?>"><?php echo $lang['wt_invite'];?></a></span>
    </div>
  </div>
</div>
    ...
    $("#rtoolbar_cart").click(function(){
        if ($("#content-cart").css('right') == '-250px') {
    		...
    		if (!$("#rtoolbar_cartlist").html()) {
    			$("#rtoolbar_cartlist").load('<?php echo urlShop('cart','ajax_load',array('type'=>'html'));?>');
    		}
        } else {
        	$(".close").click();
        	$(".chat-list").css("display",'none');
...
var topMyCity = function($) {
    "use strict";
    var areaUrl = '<?php echo urlShop('index','area_list',array('area_id'=>0)); ?>';
    var $element = {};
