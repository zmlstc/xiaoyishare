...
<link href="<?php echo SELLER_TEMPLATES_URL;?>/css/header.css" rel="stylesheet" type="text/css">
...
<script>var COOKIE_PRE = '<?php echo COOKIE_PRE;?>';var _CHARSET = '<?php echo strtolower(CHARSET);?>';var SITEURL = '<?php echo BASE_SITE_URL;?>';var MEMBER_SITE_URL = '<?php echo MEMBER_SITE_URL;?>';var SELLER_TEMPLATES_URL = '<?php echo SELLER_TEMPLATES_URL;?>';var STATIC_SITE_URL = '<?php echo STATIC_SITE_URL;?>';var SHOP_TEMPLATES_URL = '<?php echo SELLER_TEMPLATES_URL;?>';</script>
