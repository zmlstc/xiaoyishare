...
.dialog_close_button { display: block; width: 21px; height: 21px; background: url(<?php echo SELLER_TEMPLATES_URL;?>/keyword/images/member/ico.gif) 0 -761px; position: absolute; top: 10px; right: 10px; }
.dialog_close_button:hover { background: url(<?php echo SELLER_TEMPLATES_URL;?>/keyword/images/member/ico.gif) 0 -783px; }
...
.tab { width: 100%; height: 28px; line-height: 26px; background: url(<?php echo SELLER_TEMPLATES_URL;?>/keyword/images/member/tab.gif) repeat-x bottom; }
...
.eject_con .adds .submit .btn { border: 0; width: 120px; height: 32px; background: url(<?php echo SELLER_TEMPLATES_URL;?>/keyword/images/member/btn.gif) no-repeat 0 -253px; cursor: pointer; font-weight: bold; color: #3f3d3e; }

.sign_box { float: left; width: 300px; }
.eject_con .adds .sign { float: left; width: 150px; height: 50px; background: url(<?php echo SELLER_TEMPLATES_URL;?>/keyword/images/member/default.gif); margin-right: 5px; }
</style>
...
<div class="eject_con">
 <div class="adds">
        <div id="warning"></div>
        <form id="category_form" method="post" target="pop_warning" action="<?php echo urlSeller('wechat_menu',$output['t'],array('id'=>$output['id']);?>">
        <ul>
            <li>
                <h3>分类名称:</h3>
