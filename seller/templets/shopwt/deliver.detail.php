...
$(function(){
	...
	$.getJSON('<?php echo urlSeller('seller_center','get_express',array('e_code'=>$output['e_code'],'shipping_code'=>$output['order_info']['shipping_code'],'c'=>random(7)));?>',function(data){
		if(data){
			data = var_send+data;
