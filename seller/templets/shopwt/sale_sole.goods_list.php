...
<?php } else { ?>
  ...
  <a class="wtbtn wtbtn-aqua" href="<?php echo urlSeller('sale_sole', 'sole_quota_add');?>" title="购买套餐"><i class="icon-money"></i>购买套餐</a>
  <?php } else { ?>
  ...
  <?php } ?>
  <a class="wtbtn wtbtn wtbtn-aqua" href="<?php echo urlSeller('sale_sole', 'sole_renew');?>"><i class="icon-money"></i>套餐续费</a>
  <?php } ?>
<?php } ?>
...
$(function(){
    ...
    $('input[wttype="btn_search_goods"]').click(function(){
        var _url = '<?php echo urlSeller('sale_sole', 'sole_select_goods');?>';
    ...
    $('div[wttype="div_goods_select"],tr[data-gid]').on('click', 'a[wttype="a_choose_goods"]', function(){
        var _url = '<?php echo urlSeller('sale_sole', 'choosed_goods');?>';
    ...
    $('tbody[wttype="choose_goods_list"]').on('click','a[wttype="del_choosed"]', function(){
        $this = $(this);
        var _url = '<?php echo urlSeller('sale_sole', 'del_choosed_goods');?>';
        eval('var data_str = ' + $(this).attr('data-param'));
