...
<link href="<?php echo SELLER_TEMPLATES_URL?>/css/store_decoration.css" rel="stylesheet" type="text/css">
...
<div class="wtsc-decoration-box">
  <div class="wtsc-decoration-menu" id="waypoints">
    ...
    <ul class="menu">
      ...
      <li><a id="btn_preview" href="<?php echo urlSeller('decoration', 'decoration_preview', array('decoration_id' => $_GET['decoration_id']));?>" target="_blank"><i class="preview"></i>设计预览</a></li>
  ...
  <div id="store_decoration_content" style="<?php echo $output['decoration_background_style'];?>">
    ...
    <div id="store_decoration_area" class="store-decoration-page">
      ...
      <?php require('decoration_block.php');?>
      <?php } ?>
      <?php } ?>
    </div>
  </div>
...
<script type="text/javascript"> 
    ...
    var URL_DECORATION_ALBUM_UPLOAD = '<?php echo urlSeller('decoration', 'decoration_album_upload');?>';
    var URL_DECORATION_BACKGROUND_SETTING_SAVE = '<?php echo urlSeller('decoration', 'decoration_background_setting_save');?>';
    var URL_DECORATION_NAV_SAVE = '<?php echo urlSeller('decoration', 'decoration_nav_save');?>';
    var URL_DECORATION_BANNER_SAVE = '<?php echo urlSeller('decoration', 'decoration_banner_save');?>';
    var URL_DECORATION_BLOCK_ADD = '<?php echo urlSeller('decoration', 'decoration_block_add');?>';
    var URL_DECORATION_BLOCK_DEL = '<?php echo urlSeller('decoration', 'decoration_block_del');?>';
    var URL_DECORATION_BLOCK_SAVE = '<?php echo urlSeller('decoration', 'decoration_block_save');?>';
    var URL_DECORATION_BLOCK_SORT = '<?php echo urlSeller('decoration', 'decoration_block_sort');?>';
    var URL_DECORATION_GOODS_SEARCH = '<?php echo urlSeller('decoration', 'goods_search');?>';
    var LOADING_IMAGE = '<?php echo SELLER_TEMPLATES_URL . DS . 'images/loading.gif';?>';
    var POSHYTIP = {
