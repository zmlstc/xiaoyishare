  ...
  <div class="wtsc-order-info">
    ...
    <div class="wtsc-order-condition">
      ...
      <ul>
        ...
        <li>2. 如果该订单是一个无效订单，您可以点击 <a href="javascript:void(0)" class="wtbtn-mini" wt_type="dialog" dialog_width="480" dialog_title="取消订单" dialog_id="buyer_order_cancel_order" uri="<?php echo urlSeller('order_vr','change_state',array('state_type'=>'order_cancel','order_id'=>$output['order_info']['order_id'],'order_sn'=>$output['order_info']['order_sn']));?>"  id="order_action_cancel">取消订单</a>。 </li>
