<div class="goods-gallery add-step2"> <a class="sample_demo" id="select_s" href="<?php echo urlSeller('album','pic_list',array('item'=>'des'));?>" style="display:none;"><?php echo $lang['wt_submit'];?></a>
