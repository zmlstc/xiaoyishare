...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#btn_search_goods').on('click', function() {
            var url = "<?php echo urlSeller('sale_pingou', 'goods_select');?>";
        ...
        $('#div_goods_search_result').on('click', '#btn_submit', function() {
            ...
            if(!isNaN(pingou_price) && pingou_price > 0 && pingou_price < goods_price) {
                $.post('<?php echo urlSeller('sale_pingou', 'pingou_goods_add');?>', 
        ...
        $('#btn_edit_pingou_goods_submit').on('click', function() {
            ...
            if(!isNaN(pingou_price) && pingou_price > 0 && pingou_price < goods_price) {
                $.post('<?php echo urlSeller('sale_pingou', 'pingou_goods_price_edit');?>',
        ...
        $('#pingou_goods_list').on('click', '[wttype="btn_del_pingou_goods"]', function() {
            ...
            if(confirm('确认删除？')) {
                var pingou_goods_id = $(this).attr('data-pingou-goods-id');
                $.post('<?php echo urlSeller('sale_pingou', 'pingou_goods_delete');?>',
...
<div class="bottom">
  <label class="submit-border"><input type="submit" class="submit" id="submit_back" value="<?php echo $lang['wt_back'].$lang['pingou_index'];?>" onclick="window.location='<?php echo urlSeller('sale_pingou','pingou_list');?>'"></label>
</div>
