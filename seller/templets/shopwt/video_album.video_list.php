  ...
  <table class="search-form">
    <tbody>
      <tr>
        ...
        <th>排序方式</th>
        <td class="w100">
          <form name="select_sort" id="select_sort" action="<?php echo urlSeller('video','album_video_list');?>">
      ...
      <ul>
        ...
        <li>
          <dl>
            ...
            <dd class="buttons">
              <a href="javascript:void(0)" onclick="ajax_get_confirm('您确定进行该操作吗?注意：使用中的视频也将被删除','<?php echo urlSeller('video','album_video_del',array('id'=>$v['video_id']));?>');"><i class="icon-trash"></i>删除视频</a> <a title="新窗口打开视频" target="_blank" href="<?php echo goodsVideoPath($v['video_cover'],$_SESSION['store_id']);?>"><i class="icon-film"></i>打开视频</a> </dd>
          </dl>
        </li>
        <?php }?>
      </ul>
