...
<div class="tabmenu">
  ...
  <a href="<?php echo urlSeller('plate', 'plate_add');?>" class="wtbtn wtbtn-mint" title="添加关联版式">添加关联版式</a>
</div>
...
<form method="get" action="<?php echo urlSeller('plate','index');?>">
  ...
  <thead>
    ...
    <tr>
      ...
      <td colspan="10"><label for="all" ><?php echo $lang['wt_select_all'];?></label>
        <a href="javascript:void(0);" wt_type="batchbutton" uri="<?php echo urlSeller('plate', 'drop_plate');?>" name="p_id" confirm="<?php echo $lang['wt_ensure_del'];?>" class="wtbtn-mini"><i class="icon-trash"></i><?php echo $lang['wt_del'];?></a>
      </td>
    </tr>
    <?php } ?>
  </thead>
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle">
        <span><a href="<?php echo urlSeller('plate', 'plate_edit', array('p_id' => $val['plate_id']));?>" class="btn-bluejeans"><i class="icon-edit"></i><p><?php echo $lang['wt_edit'];?></p></a></span>
        <span><a href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['wt_ensure_del'];?>', '<?php echo urlSeller('plate', 'drop_plate', array('p_id' => $val['plate_id']));?>');" class="btn-grapefruit"><i class="icon-trash"></i><p><?php echo $lang['wt_del'];?></p></a></span>
      </td>
    </tr>
    <?php } ?>
    <?php } else { ?>
