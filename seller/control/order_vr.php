...
class order_vrControl extends BaseSellerControl {
    ...
    private function _order_cancel($order_info, $post) {
        if(!chksubmit()) {
            ...
            Tpl::output('order_info',$order_info);
            Tpl::showpage('order_vr.cancel','null_layout');
            exit();
        } else {
            $model_order_vr = Model('order_vr');
    ...
    public function exchangeWt() {
        if (chksubmit()) {
            ...
            Tpl::showpage('order_vr.exchange');
        }
    }
    ...
    private function _exchange() {
        ...
        if ($update) {
            ...
            $order_info['order_url'] = urlSeller('order_vr','show_order',array('order_id' => $order_info['order_id']));
    ...
    private function profile_menu($menu_type='',$menu_key='') {
        ...
        switch ($menu_type) {
            case 'list':
            $menu_array = array(
            array('menu_key'=>'order',        'menu_name'=>Language::get('wt_member_path_all_order'), 'menu_url'=>urlSeller('order_vr')),
            array('menu_key'=>'state_new',          'menu_name'=>Language::get('wt_member_path_wait_pay'),  'menu_url'=>urlSeller('order_vr','',array('state_type'=>'state_new'))),
            array('menu_key'=>'state_pay',          'menu_name'=>'已付款',  'menu_url'=>urlSeller('order_vr','',array('state_type'=>'state_pay'))),
            array('menu_key'=>'state_success',      'menu_name'=>Language::get('wt_member_path_finished'),  'menu_url'=>urlSeller('order_vr','',array('state_type'=>'state_success'))),
            array('menu_key'=>'state_cancel',       'menu_name'=>Language::get('wt_member_path_canceled'),  'menu_url'=>urlSeller('order_vr','',array('state_type'=>'state_cancel'))),
            );
            break;
            case 'exchange':
                $menu_array = array(
                ...
                array('menu_key'=>'state_success',      'menu_name'=>Language::get('wt_member_path_finished'),  'menu_url'=>urlSeller('order_vr','',array('state_type'=>'state_success'))),
                array('menu_key'=>'state_cancel',       'menu_name'=>Language::get('wt_member_path_canceled'),  'menu_url'=>urlSeller('order_vr','',array('state_type'=>'state_cancel'))),
                array('menu_key'=>'exchange',           'menu_name'=>'兑换码兑换',  'menu_url'=>urlSeller('order_vr','exchange')),
                );
                break;
        }
