...
class sale_couControl extends BaseSellerControl
{
    ...
    public function cou_quota_addWt()
    {
        ...
        Tpl::showpage('sale_cou.quota_add');
    }
    ...
    public function cou_quota_add_saveWt()
    {
        ...
        showDialog('加价购套餐购买成功', urlSeller('sale_cou','cou_list'), 'succ');
    }
    ...
    public function cou_add_saveWt()
    {
        ...
        if ($result) {
            ...
            $editUrl = urlSeller('sale_cou','cou_edit',array('cou_id'=>$result));
    ...
    public function cou_edit_saveWt()
    {
        ...
        showDialog(Language::get('wt_common_op_succ'), urlSeller('sale_cou','cou_list'), 'succ', '', 3);
    }
    ...
    public function cou_delWt()
    {
        ...
        if ($result) {
            ...
            showDialog(L('wt_common_op_succ'), urlSeller('sale_cou','cou_list'), 'succ');
        } else {
    ...
    public function cou_level_skuWt()
    {
         ...
         * 商品分类
         */
        $goods_class = Model('store_goods_class')->getClassTree(array(
        ...
        Tpl::showpage('sale_cou.cou_level_sku', 'null_layout');
    }
    ...
    public function cou_skuWt()
    {
        ...
        Tpl::showpage('sale_cou.cou_sku', 'null_layout');
    }
    ...
    private function profile_menu($menu_key='')
    {
        $menu_array = array(
            1 => array(
                'menu_key' => 'cou_list',
                'menu_name' => '活动列表',
                'menu_url' => urlSeller('sale_cou','cou_list'),
            ),
        );
        switch ($menu_key) {
            case 'cou_quota_add':
                $menu_array[] = array(
                    ...
                    'menu_name' => '购买套餐',
                    'menu_url' => urlSeller('sale_cou','cou_add'),
                );
                break;
            case 'cou_add':
                $menu_array[] = array(
