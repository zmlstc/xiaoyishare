...
class snsControl extends BaseSellerControl{
    ...
    public function addWt() {
        ...
        $this->profile_menu ( 'sns_add' );
        Tpl::showpage ('sns_add' );
    }
    ...
    public function store_sns_saveWt(){
        ...
        if($rs){
            showDialog(Language::get('wt_common_op_succ'), urlSeller('sns'), 'succ');
        }else{
    ...
    public function settingWt(){
        ...
        $this->profile_menu('sns_setting');
        Tpl::showpage('sns_setting');
    }
    ...
    private function profile_menu($menu_key) {
        $menu_array = array(
                1=>array('menu_key'=>'sns_add', 'menu_name'=>Language::get('store_sns_add'), 'menu_url'=>urlSeller('sns','add')),
                2=>array('menu_key'=>'sns_setting', 'menu_name'=>Language::get('store_sns_setting'), 'menu_url'=>urlSeller('sns','setting')),
                3=>array('menu_key'=>'sns_brower', 'menu_name'=>Language::get('store_sns_browse'), 'menu_url'=>urlSeller('store_snshome', '', array('sid' => $_SESSION['store_id'])), 'target'=>'_blank')
        );
