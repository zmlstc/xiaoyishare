...
class settingControl extends BaseSellerControl {
...
/* 			$store_name=$_POST['store_name'];
			...
			$PhpQRCode->set('date',WAP_SITE_URL . '/index.php?store_id='.$store_id);
            ...
            showDialog(Language::get('wt_common_save_succ'),urlSeller('setting','store_setting'),'succ');
        }
        /**
         * 实例化店铺等级模型
         */
...
/*         $editor_multimedia = false;
    ...
    public function store_slideWt() {
        ...
        if ($_POST['form_submit'] == 'ok'){
            ...
            showDialog(Language::get('wt_common_save_succ'),urlSeller('setting','store_slide'),'succ');
        }
    ...
    public function themeWt(){
         ...
         * 当前店铺预览图片
         */
        $curr_image = SELLER_TEMPLATES_URL.'/store/style/'.$curr_store_theme.'/images/preview.jpg';
        $curr_theme = array(
        ...
        foreach ($style_data as $key => $val){
            if (in_array($key,$themes)){
                ...
                'image'=>SELLER_TEMPLATES_URL.'/store/style/'.$key.'/images/preview.jpg'
                );
            }
        }
        /**
    ...
    public function store_mobileWt()
    {
        ...
        if (chksubmit()) {
            ...
            showDialog('保存成功', urlSeller('setting','store_mobile'), 'succ');
        }
        ...
        Tpl::showPage('setting.store_mobile');
    }
    ...
    private function profile_menu($menu_key='') {
        ...
        $menu_array = array(
            1=>array('menu_key'=>'setting','menu_name'=>'店铺介绍','menu_url'=>urlSeller('setting','store_setting')),
            2=>array('menu_key'=>'setname','menu_name'=>'店铺名称','menu_url'=>urlSeller('setting','setname')),
            4=>array('menu_key'=>'store_slide','menu_name'=>Language::get('wt_member_path_store_slide'),'menu_url'=>urlSeller('setting','store_slide')),
