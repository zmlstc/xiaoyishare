...
class sale_xianshiControl extends BaseSellerControl {
    ...
    public function xianshi_saveWt() {
        ...
        if($result) {
            ...
            showDialog(Language::get('xianshi_add_success'),urlSeller('sale_xianshi','xianshi_manage',array('xianshi_id'=>$result)),'succ','',3);
        }else {
    ...
    public function xianshi_edit_saveWt() {
        ...
        if($result && $result1) {
            ...
            showDialog(Language::get('wt_common_op_succ'),urlSeller('sale_xianshi','xianshi_list'),'succ','',3);
        }else {
    ...
    public function xianshi_delWt() {
        ...
        if($result) {
            ...
            showDialog(L('wt_common_op_succ'), urlSeller('sale_xianshi', 'xianshi_list'), 'succ');
        } else {
    ...
    public function xianshi_manageWt() {
        ...
        Tpl::showpage('sale_xianshi.manage');
    }
    ...
    public function xianshi_quota_addWt() {
        ...
        Tpl::showpage('sale_xianshi_quota.add');
    }
    ...
    public function xianshi_quota_add_saveWt() {
        ...
        showDialog(Language::get('xianshi_quota_add_success'),urlSeller('sale_xianshi','xianshi_list'),'succ');
    }
    ...
    public function goods_selectWt() {
        ...
        Tpl::showpage('sale_xianshi.goods', 'null_layout');
    }
    ...
    private function profile_menu($menu_key='') {
        $menu_array = array(
            1=>array('menu_key'=>'xianshi_list','menu_name'=>Language::get('sale_active_list'),'menu_url'=>urlSeller('sale_xianshi','xianshi_list')),
        );
        switch ($menu_key){
            case 'xianshi_add':
                $menu_array[] = array('menu_key'=>'xianshi_add','menu_name'=>Language::get('sale_join_active'),'menu_url'=>urlSeller('sale_xianshi','xianshi_add'));
                break;
            case 'xianshi_edit':
                $menu_array[] = array('menu_key'=>'xianshi_edit','menu_name'=>'编辑活动','menu_url'=>'javascript:;');
                break;
            case 'xianshi_quota_add':
                $menu_array[] = array('menu_key'=>'xianshi_quota_add','menu_name'=>Language::get('sale_buy_product'),'menu_url'=>urlSeller('sale_xianshi','xianshi_quota_add'));
                break;
            case 'xianshi_manage':
                $menu_array[] = array('menu_key'=>'xianshi_manage','menu_name'=>Language::get('sale_goods_manage'),'menu_url'=>urlSeller('sale_xianshi','xianshi_manage',array('xianshi_id'=>$_GET['xianshi_id'])));
                break;
        }
