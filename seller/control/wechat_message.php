...
class wechat_messageControl extends BaseSellerControl {
    ...
    public function follow_indexWt()
    {
        ...
        if(empty($find_data))
        {
            ...
            //showErr('请先设置微信接口！','马上去设置','index.php/wechat');return ;
        }
        ...
        $this->_curlocal('微信管理',url('w=wechat&t=follow_index'),'关注自动回复');*/
        /* 当前用户中心菜单 */
    ...
    */
    ...
    function message_indexWt()
    {
        ...
        //$this->_curlocal('微信管理',url('w=wechat&t=message_index'),'消息自动回复');
