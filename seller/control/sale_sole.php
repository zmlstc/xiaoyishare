...
class sale_soleControl extends BaseSellerControl {
    ...
    public function sole_select_goodsWt() {
        ...
        Tpl::showpage('sale_sole.select_goods', 'null_layout');
    }
    ...
    public function sole_quota_addWt() {
        if (chksubmit()) {
            ...
            if ($quantity <= 0 || $quantity > 12) {
                showDialog('参数错误，购买失败。', urlSeller('sale_sole', 'sole_quota_add'), '', 'error' );
            }
            // 实例化模型
            $model_sole = Model('p_sole');
            ...
            if ($return) {
                ...
                showDialog('购买成功', urlSeller('sale_sole', 'sole_goods_list'), 'succ');
            } else {
                showDialog('购买失败', urlSeller('sale_sole', 'sole_quota_add'));
            }
        }
        // 输出导航
        self::profile_menu('sole_quota_add', 'sole_quota_add');
        Tpl::showpage('sale_sole.quota_add');
    }
    ...
    public function sole_renewWt() {
        if (chksubmit()) {
            ...
            if ($return) {
                ...
                showDialog('购买成功', urlSeller('sale_sole', 'sole_list'), 'succ');
            } else {
                showDialog('购买失败', urlSeller('sale_sole', 'sole_quota_add'));
            }
        }
    ...
    public function choosed_goodsWt() {
        ...
        Tpl::showpage('sale_sole.choosed_goods', 'null_layout');
    }
    ...
    private function profile_menu($menu_type,$menu_key='') {
        ...
        switch ($menu_type) {
            case 'sole_goods_list':
                $menu_array = array(
                    1=>array('menu_key'=>'sole_goods_list', 'menu_name'=>'商品列表', 'menu_url'=>urlSeller('sale_sole', 'sole_goods_list'))
                );
                break;
            case 'sole_quota_add':
                $menu_array = array(
                    1=>array('menu_key'=>'sole_goods_list', 'menu_name'=>'商品列表', 'menu_url'=>urlSeller('sale_sole', 'sole_goods_list')),
                    2=>array('menu_key'=>'sole_quota_add', 'menu_name'=>'购买套餐', 'menu_url'=>urlSeller('sale_sole', 'sole_quota_add'))
                );
                break;
            case 'sole_renew':
                $menu_array = array(
                    1=>array('menu_key'=>'sole_goods_list', 'menu_name'=>'商品列表', 'menu_url'=>urlSeller('sale_sole', 'sole_goods_list')),
                    2=>array('menu_key'=>'sole_renew', 'menu_name'=>'套餐续费', 'menu_url'=>urlSeller('sale_sole', 'sole_renew'))
                );
                break;
        }
