...
class orderControl extends BaseSellerControl {
    ...
    private function _order_cancel($order_info, $post) {
        ...
        if(!chksubmit()) {
            ...
            Tpl::showpage('order.cancel','null_layout');
            exit();
         } else {
    ...
    private function _order_ship_price($order_info, $post) {
        ...
        if(!chksubmit()) {
            Tpl::output('order_info',$order_info);
            Tpl::output('order_id',$order_info['order_id']);
            Tpl::showpage('order.edit_price','null_layout');
            exit();
        } else {
	...
	private function _order_spay_price($order_info, $post) {
	    ...
	    if(!chksubmit()) {
	        Tpl::output('order_info',$order_info);
	        Tpl::output('order_id',$order_info['order_id']);
            Tpl::showpage('order.edit_spay_price','null_layout');
            exit();
        } else {
    ...
    public function order_printWt() {
        ...
        Tpl::showpage('order.print',"null_layout");
    }
    ...
    private function profile_menu($menu_type='',$menu_key='') {
        ...
        switch ($menu_type) {
            case 'list':
            $menu_array = array(
            array('menu_key'=>'order',        'menu_name'=>Language::get('wt_member_path_all_order'), 'menu_url'=>urlSeller('order')),
            array('menu_key'=>'state_new',          'menu_name'=>Language::get('wt_member_path_wait_pay'),  'menu_url'=>urlSeller('order','',array('state_type'=>'state_new'))),
            array('menu_key'=>'state_pay',          'menu_name'=>Language::get('wt_member_path_wait_send'), 'menu_url'=>urlSeller('order','',array('state_type'=>'state_pay'))),
            array('menu_key'=>'state_notakes',      'menu_name'=>'待自提', 'menu_url'=>urlSeller('order','',array('state_type'=>'state_notakes'))),
            array('menu_key'=>'state_send',         'menu_name'=>Language::get('wt_member_path_sent'),      'menu_url'=>urlSeller('order','',array('state_type'=>'state_send'))),
            array('menu_key'=>'state_success',      'menu_name'=>Language::get('wt_member_path_finished'),  'menu_url'=>urlSeller('order','',array('state_type'=>'state_success'))),
            array('menu_key'=>'state_cancel',       'menu_name'=>Language::get('wt_member_path_canceled'),  'menu_url'=>urlSeller('order','',array('state_type'=>'state_cancel'))),
            );
            break;
        }
