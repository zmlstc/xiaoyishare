...
class deliverControl extends BaseSellerControl {
    ...
    public function buyer_address_editWt() {
        ...
        Tpl::showpage('deliver.buyer_address.edit','null_layout');
    }
    ...
    public function send_address_selectWt() {
        ...
        Tpl::showpage('deliver.daddress.select','null_layout');
    }
    ...
    public function delay_receiveWt(){
        ...
        if (chksubmit()) {
            ...
            Tpl::output('order_info',$order_info);
            Tpl::showpage('deliver.delay_receive','null_layout');
            exit();
        }
    }
    ...
    public function waybill_printWt() {
        ...
        if(empty($store_waybill_info)) {
            showMessage('请首先绑定打印模板', urlSeller('waybill', 'waybill_manage'), '', 'error');
        }
    ...
    private function profile_menu($menu_type,$menu_key='') {
        ...
        switch ($menu_type) {
            case 'deliver':
                $menu_array = array(
                array('menu_key'=>'deliverno',          'menu_name'=>Language::get('wt_member_path_deliverno'), 'menu_url'=>urlSeller('deliver','',array('state'=>'deliverno'))),
                array('menu_key'=>'delivering',         'menu_name'=>Language::get('wt_member_path_delivering'),    'menu_url'=>urlSeller('deliver','',array('state'=>'delivering'))),
                array('menu_key'=>'delivered',      'menu_name'=>Language::get('wt_member_path_delivered'), 'menu_url'=>urlSeller('deliver','',array('state'=>'delivered'))),
                );
                break;
            case 'search':
                $menu_array = array(
                1=>array('menu_key'=>'nodeliver',           'menu_name'=>Language::get('wt_member_path_deliverno'), 'menu_url'=>urlSeller('deliver','',array('state'=>'nodeliver'))),
                2=>array('menu_key'=>'delivering',          'menu_name'=>Language::get('wt_member_path_delivering'),    'menu_url'=>urlSeller('deliver','',array('state'=>'delivering'))),
                3=>array('menu_key'=>'delivered',       'menu_name'=>Language::get('wt_member_path_delivered'), 'menu_url'=>urlSeller('deliver','',array('state'=>'delivered'))),
