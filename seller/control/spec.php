...
class specControl extends BaseSellerControl {
    ...
    public function add_specWt(){
        ...
        Tpl::showpage('spec.add', 'null_layout');
    }
    ...
    private function _profile_menu($menu_type, $menu_key) {
        ...
        switch ($menu_type) {
            case 'spec':
                $menu_array = array(
                    array('menu_key' => 'spec', 'menu_name' => L('wt_member_path_store_spec'), 'menu_url' => urlSeller('spec'))
                );
            break;
        }
