...
class sale_comboControl extends BaseSellerControl {
    ...
    public function combo_listWt() {
        ...
        Tpl::showpage('sale_combo.goods_list');
    }
    ...
    public function combo_quota_addWt() {
        if (chksubmit()) {
            ...
            if ($quantity <= 0 || $quantity > 12) {
                showDialog('参数错误，购买失败。', urlSeller('sale_combo', 'combo_quota_add'), '', 'error' );
            }
            // 实例化模型
            $model_combo = Model('p_combo_quota');
            ...
            if ($return) {
                ...
                showDialog('购买成功', urlSeller('sale_combo', 'combo_goods_list'), 'succ');
            } else {
                showDialog('购买失败', urlSeller('sale_combo', 'combo_quota_add'));
            }
        }
        // 输出导航
        $this->profile_menu('combo_quota_add', 'combo_quota_add');
        Tpl::showpage('sale_combo.quota_add');
    }
    ...
    public function combo_renewWt() {
        if (chksubmit()) {
            ...
            if ($return) {
                ...
                showDialog('购买成功', urlSeller('sale_combo', 'combo_list'), 'succ');
            } else {
                showDialog('购买失败', urlSeller('sale_combo', 'combo_quota_add'));
            }
        }
    ...
    public function combo_select_goodsWt() {
        ...
        Tpl::showpage('sale_combo.select_goods', 'null_layout');
    }
    ...
    public function choosed_goodsWt() {
        ...
        Tpl::showpage('sale_combo.choosed_goods');
    }
    ...
    private function profile_menu($menu_type, $menu_key = '')
    {
        ...
        switch ($menu_type) {
            case 'combo_goods_list':
                $menu_array = array(
                    1=>array('menu_key'=>'combo_goods_list', 'menu_name'=>'商品列表', 'menu_url'=>urlSeller('sale_combo', 'combo_goods_list'))
                );
                break;
            ...
            case 'combo_quota_add':
                $menu_array = array(
                    1=>array('menu_key'=>'combo_goods_list', 'menu_name'=>'商品列表', 'menu_url'=>urlSeller('sale_combo', 'combo_goods_list')),
                    2=>array('menu_key'=>'combo_quota_add', 'menu_name'=>'购买套餐', 'menu_url'=>urlSeller('sale_combo', 'combo_quota_add'))
                );
                break;
            case 'combo_renew':
                $menu_array = array(
                    1=>array('menu_key'=>'combo_goods_list', 'menu_name'=>'商品列表', 'menu_url'=>urlSeller('sale_combo', 'combo_goods_list')),
                    2=>array('menu_key'=>'combo_renew', 'menu_name'=>'套餐续费', 'menu_url'=>urlSeller('sale_combo', 'combo_renew'))
                );
                break;
        }
