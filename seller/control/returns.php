...
class returnsControl extends BaseSellerControl {
    ...
    public function editWt() {
        ...
        if (chksubmit()) {
            $reload = urlSeller('returns','',array('lock'=>'1'));
            if ($return['order_lock'] == '2') {
                $reload = urlSeller('returns','',array('lock'=>'2'));
            }
    ...
    public function receiveWt() {
        ...
        Tpl::showpage('returns_receive','null_layout');
    }
    /**
     * 退货记录查看页
     *
    ...
    private function profile_menu($menu_type,$menu_key='') {
        ...
        switch ($menu_type) {
            case 'return':
                $menu_array = array(
                    array('menu_key'=>'2','menu_name'=>'售前退货',  'menu_url'=>urlSeller('returns','',array('lock'=>'2'))),
                    array('menu_key'=>'1','menu_name'=>'售后退货','menu_url'=>urlSeller('returns','',array('lock'=>'1')))
                );
                break;
        }
