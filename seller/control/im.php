...
class imControl extends BaseSellerControl {
    ...
    public function get_user_listWt() {
        ...
        Tpl::showpage('chat_user','null_layout');
    }
    /**
     * 小导航
     *
    ...
    private function profile_menu($menu_type,$menu_key='') {
        ...
        switch ($menu_type) {
            case 'im':
                $menu_array = array(
                    array('menu_key'=>'index','menu_name'=>'聊天记录查询',  'menu_url'=>urlSeller('im'))
                );
                break;
        }
