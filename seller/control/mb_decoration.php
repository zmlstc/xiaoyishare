...
const ARTICLE_STATE_PUBLISHED = 3;
    ...
    public function decoration_settingWt() {
        ...
        Tpl::showpage('mb_decoration.setting');
    }
    ...
    public function special_item_saveWt() {
        ...
        if($result) {
               showMessage(L('wt_common_save_succ'), urlSeller('mb_decoration', 'decoration_edit'));
    ...
    public function decoration_albumWt() {
        ...
        Tpl::showpage('mb_decoration.album');
    }
    ...
    public function decoration_menuWt() {
        ...
        Tpl::showpage('mb_decoration.menu');
    }
    /**
     * 图片上传
     */
    ...
    public function decoration_editWt() {
        ...
        Tpl::showpage('mb_decoration.edit');
    }
    ...
    public function decoration_block_addWt() {
        ...
        if($block_id) {
            ...
            Tpl::showpage('decoration_block', 'null_layout');
    ...
    private function _get_block_html($content, $module_type) {
        ...
        Tpl::showpage('decoration_module.' . $module_type, 'null_layout');
        $temp = ob_get_contents();
        ob_end_clean();
        return $temp;
    }
    ...
    public function goods_searchWt() {
        ...
        Tpl::showpage('decoration_module.goods', 'null_layout');
    }
    /**
     * 商品列表
     */
    ...
    public function decoration_previewWt() {
        ...
        Tpl::showpage('decoration.preview');
    }
    ...
    public function decoration_buildWt() {
        ...
        ob_start();
        Tpl::showpage('decoration.preview', 'null_layout');
    ...
    private function profile_menu($menu_key='') {
        $menu_array = array(
            1=>array('menu_key'=>'decoration_setting','menu_name'=>'手机店铺装修','menu_url'=>urlSeller('mb_decoration', 'decoration_setting')),
            2=>array('menu_key'=>'decoration_album','menu_name'=>'首页导航设置','menu_url'=>urlSeller('mb_decoration', 'decoration_album')),
            3=>array('menu_key'=>'decoration_menu','menu_name'=>'底部菜单设置','menu_url'=>urlSeller('mb_decoration', 'decoration_menu')),//menu
        );
