...
class videoControl extends BaseSellerControl {
    ...
    public function album_video_listWt() {
        ...
        Tpl::showpage('video_album.video_list');
    }
    ...
    private function profile_menu($menu_type, $menu_key = '') {
        ...
        switch ($menu_type) {
            case 'album_video':
                $menu_array = array(
                    3 => array('menu_key' => 'video_list', 'menu_name' => '视频列表', 'menu_url' => urlSeller('video','album_video_list',array('id'=>intval($_GET['id']))))
                );
                break;
        }
        if (C('oss.open')) {
