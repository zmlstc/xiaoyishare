...
class sale_pingouControl extends BaseSellerControl {
    ...
    public function pingou_saveWt() {
        ...
        if($result) {
            ...
            showDialog(Language::get('wt_common_save_succ'),urlSeller('sale_pingou','pingou_manage',array('pingou_id'=>$result)),'succ','',3);
        }else {
    ...
    public function pingou_edit_saveWt() {
        ...
        if($result) {
            ...
            showDialog(Language::get('wt_common_op_succ'),urlSeller('sale_pingou'),'succ','',3);
        }else {
    ...
    public function pingou_delWt() {
        ...
        if($result) {
            ...
            showDialog(L('wt_common_op_succ'), urlSeller('sale_pingou', 'pingou_list'), 'succ');
        } else {
    ...
    public function pingou_manageWt() {
        ...
        Tpl::showpage('sale_pingou.manage');
    }
    ...
    public function quota_addWt() {
        //输出导航
        self::profile_menu('pingou_add');
        Tpl::showpage('sale_pingou_quota.add');
    }
    ...
    public function quota_add_saveWt() {
        ...
        showDialog(Language::get('wt_common_save_succ'),urlSeller('sale_pingou'),'succ');
    }
    ...
    public function goods_selectWt() {
        ...
        Tpl::showpage('sale_pingou.goods', 'null_layout');
    }
    ...
    private function profile_menu($menu_key='') {
        $menu_array = array(
            1=>array('menu_key'=>'pingou_list','menu_name'=>'活动列表','menu_url'=>urlSeller('sale_pingou','pingou_list')),
        );
        switch ($menu_key){
            case 'pingou_add':
                $menu_array[] = array('menu_key'=>'pingou_add','menu_name'=>'添加活动','menu_url'=>urlSeller('sale_pingou','pingou_add'));
                break;
            case 'pingou_edit':
                $menu_array[] = array('menu_key'=>'pingou_edit','menu_name'=>'编辑活动','menu_url'=>'javascript:;');
                break;
            case 'quota_add':
                $menu_array[] = array('menu_key'=>'pingou_add','menu_name'=>'购买套餐','menu_url'=>urlSeller('sale_pingou','quota_add'));
                break;
            case 'pingou_manage':
                $menu_array[] = array('menu_key'=>'pingou_manage','menu_name'=>'商品管理','menu_url'=>urlSeller('sale_pingou','pingou_manage',array('pingou_id'=>.$_GET['pingou_id'])));
                break;
        }
