...
class stat_saleControl extends BaseSellerControl {
    ...
    public function salelistWt(){
        ...
        Tpl::output('show_page',$model->showpage(2));
        Tpl::output('actionurl',urlSeller($this->search_arr['w'],$this->search_arr['t'],array('order_type'=>$this->search_arr['order_type'],'c'=>$this->search_arr['t'])));
    ...
    private function profile_menu($menu_key='') {
        $menu_array = array(
            1=>array('menu_key'=>'sale','menu_name'=>'销售统计','menu_url'=>urlSeller('stat_sale','sale')),
            2=>array('menu_key'=>'area','menu_name'=>'区域分布','menu_url'=>urlSeller('stat_sale','area')),
            3=>array('menu_key'=>'buying','menu_name'=>'购买分析','menu_url'=>urlSeller('stat_sale','buying')),
        );
