...
class goods_classControl extends BaseSellerControl {
    ...
    public function indexWt() {
        ...
        if($_GET['type'] == 'ok') {
            ...
            self::profile_menu('goods_class','goods_class');
    ...
    public function goods_class_saveWt() {
        ...
        if(isset($_POST['stc_id'])) {
            ...
            if($state) {
                showDialog(Language::get('wt_common_save_succ'),urlSeller('goods_class'),'succ',empty($_GET['inajax']) ?'':'CUR_DIALOG.close();');
            } else {
    ...
    public function drop_goods_classWt() {
        ...
        if ($drop_state){
            showDialog(Language::get('wt_common_del_succ'),urlSeller('goods_class','store_goods_class'),'succ');
        }else{
    ...
    private function profile_menu($menu_type,$menu_key='') {
        ...
        switch ($menu_type) {
            case 'goods_class':
                $menu_array = array(
                1=>array('menu_key'=>'goods_class','menu_name'=>'店铺分类',   'menu_url'=>urlSeller('goods_class','store_goods_class')));
                break;
        }
