...
class callcenterControl extends BaseSellerControl {
    ...
    public function saveWt(){
        if(chksubmit()){
            ...
            showDialog(Language::get('wt_common_save_succ'), urlSeller('callcenter'), 'succ');
        }
    }
    /**
     * 用户中心右边，小导航
    ...
    private function profile_menu($menu_key) {
        $menu_array = array(
            1=>array('menu_key'=>'callcenter','menu_name'=>Language::get('wt_member_path_store_callcenter'),'menu_url'=>urlSeller('callcenter')),
        );
