...
class sale_mansongControl extends BaseSellerControl {
    ...
    public function mansong_saveWt() {
        ...
        if($mansong_id) {
            ...
            showDialog(Language::get('mansong_add_success'), urlSeller('sale_mansong', 'mansong_list'), 'succ');
        } else {
    ...
    public function mansong_detailWt() {
        ...
        Tpl::showpage('sale_mansong.detail');
    }
    ...
    public function mansong_delWt() {
        ...
        if($result) {
            ...
            showDialog(L('wt_common_op_succ'), urlSeller('sale_mansong', 'mansong_list'), 'succ');
        } else {
    ...
    public function mansong_quota_addWt() {
        ...
        Tpl::showpage('sale_mansong_quota.add');
    }
    ...
    public function mansong_quota_add_saveWt() {
        ...
        showDialog(Language::get('mansong_quota_add_success'), urlSeller('sale_mansong', 'mansong_list'), 'succ');
    }
    ...
    public function search_goodsWt() {
        ...
        Tpl::showpage('sale_mansong.goods', 'null_layout');
    }
    ...
    private function profile_menu($menu_key='') {
        $menu_array = array(
            1=>array('menu_key'=>'mansong_list','menu_name'=>Language::get('sale_active_list'),'menu_url'=>urlSeller('sale_mansong', 'mansong_list')),
        );
        switch ($menu_key){
            case 'mansong_add':
                $menu_array[] = array('menu_key'=>'mansong_add','menu_name'=>Language::get('sale_join_active'),'menu_url'=>urlSeller('sale_mansong', 'mansong_add'));
                break;
            case 'mansong_quota_add':
                $menu_array[] = array('menu_key'=>'mansong_quota_add','menu_name'=>Language::get('sale_buy_product'),'menu_url'=>urlSeller('sale_mansong', 'mansong_quota_add'));
                break;
            case 'mansong_detail':
                $menu_array[] = array('menu_key'=>'mansong_detail','menu_name'=>Language::get('mansong_active_content'),'menu_url'=>urlSeller('sale_mansong', 'mansong_detail', array('mansong_id' => $_GET['mansong_id'])));
                break;
        }
