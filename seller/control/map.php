...
class mapControl extends BaseSellerControl {
    ...
    public function listWt() {
        ...
        self::profile_menu('map','list');
        Tpl::showpage('map.list');
    }
    /**
     * 增加店铺地址
     *
    ...
    public function add_mapWt() {
        ...
        Tpl::showpage('map.add','null_layout');
    }
    /**
     * 编辑店铺地址
     *
    ...
    public function edit_mapWt() {
        ...
        $map = $map_list[0];
        Tpl::output('map',$map);
        Tpl::showpage('map.edit','null_layout');
    }
    /**
     * 更新地址坐标
     *
    ...
    private function profile_menu($menu_type,$menu_key='') {
        ...
        switch ($menu_type) {
            case 'map':
                $menu_array = array(
                    array('menu_key'=>'index','menu_name'=>'地图显示 ',  'menu_url'=>urlSeller('map')),
                    array('menu_key'=>'list','menu_name'=>'列表显示 ',  'menu_url'=>urlSeller('map','list'))
                );
                break;
        }
