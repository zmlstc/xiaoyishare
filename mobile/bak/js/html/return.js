...
$(function(){
    ...
    $.getJSON(ApiUrl + '/index.php/member_refund/refund_form',{key:key,order_id:getQueryString('order_id'),order_goods_id:getQueryString('order_goods_id')}, function(result) {
        ...
        $('input[name="refund_pic"]').ajaxUploadImage({
            url : ApiUrl + "/index.php/member_refund/upload_pic",
            data:{key:key},
        ...
        $('.btn-l').click(function(){
            ...
            $.ajax({
                type:'post',
                url:ApiUrl+'/index.php/member_refund/refund_post',
                data:param,
                dataType:'json',
                async:false,
