...
$(function(){
    ...
    $.getJSON(ApiUrl + '/index.php/member_order_vr/order_info',{key:key,order_id:order_id}, function(result) {
        ...
        $.getJSON(ApiUrl + '/index.php/goods/store_o2o_addr', {store_id:result.datas.order_info.store_id},function(result){
        	if (result.datas.error) {
        		return ;
        	}
    ...
    function cancelOrderId(order_id) {
        $.ajax({
            type:"post",
            url:ApiUrl+"/index.php/member_order_vr/order_cancel",
    ...
    function toSend(){
    	...
    	$.ajax({
            type:"post",
            url:ApiUrl+"/index.php/member_order_vr/resend",
