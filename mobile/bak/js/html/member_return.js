$(function(){
    ...
    load_class.loadInit({
        url:ApiUrl + '/index.php/member_return/get_return_list',
        getparam:{key :key },
        ...
        callback:function(){
            $('.delay-btn').click(function(){
                ...
                $.getJSON(ApiUrl+'/index.php/member_return/delay_form', {key:key,return_id:return_id}, function(result){
                    ...
                    $.sDialog({
                        ...
                        okFn:function(){
                            $.ajax({
                                type:'post',
                                url:ApiUrl+'/index.php/member_return/delay_post',
