$(function (){
    ...
    if(key){
        ...
        html += '<a href="' + WapSiteUrl + '/news/index.html" class="gotop">资讯</a>' + "</div>" + '<!--<div class="copyright">' + 'Copyright&nbsp;&copy;&nbsp;2008-2018 <a href="javascript:void(0);">ShopWT www.shopwt.com</a>版权所有' + "</div>--></div>";
