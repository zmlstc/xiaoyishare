$(function(){
    ...
    $.getJSON(ApiUrl + '/index.php/member_evaluate/again', {key:key, order_id:order_id}, function(result){
        ...
        $('input[name="file"]').ajaxUploadImage({
            url : ApiUrl + "/index.php/sns_album/file_upload",
            data:{key:key},
        ...
        $('.btn-l').click(function(){
            ...
            $.ajax({//获取区域列表
                type:'post',
                url:ApiUrl+'/index.php/member_evaluate/save_again',
                data:param,
                dataType:'json',
                async:false,
