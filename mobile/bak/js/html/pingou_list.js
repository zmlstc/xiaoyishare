...
$(function(){
	//大类分类列表
	$.getJSON(ApiUrl+"/index.php/goods_class/get_child_all_list", function(result){
...
function get_list() {
    ...
    $.getJSON(ApiUrl + '/index.php/pingou/pingou_list' + window.location.search.replace('?','&'), param, function(result){
    	if(!result) {
    		result = [];
    		result.datas = [];
