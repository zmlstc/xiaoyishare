...
$(function (){
  ...
  function get_detail(goods_id) {
      //渲染页面
      $.ajax({
         url:ApiUrl+"/index.php/goods/goods_detail",
         type:"get",
	      ...
	      $("head").append(html);
            ...
            $("#wx-sha").live("click", function(){
			  ...
			  $("#qq_url").live("click", function(){
				  $.ajax({
					url: ApiUrl + "/index.php/sharepoint?gid="+data.goods_content.goods_id,
					data:{key:key},
					dataType: 'json',
					success: function (result) {
            ...
            var con = $("#rule_info").html();
              ...
              $("#add-cart").click(function (){
                ...
                var quantity = parseInt($(".buy-num").val());
                 ...
                 if(!key){
                    ...
                    $.ajax({
                       url:ApiUrl+"/index.php/member_cart/cart_add",
              ...
              if (data.goods_content.is_virtual == '1') {
                  $("#buy-now").click(function() {
                      ...
                      $.ajax({
                          type:'post',
                          url:ApiUrl+'/index.php/member_vr_buy/buy_step1',
                          data:json,
                          dataType:'json',
                          success:function(result){
                     ...
                     if(!key){
                      ...
                      if (buy_pingou == 1 &&data.goods_content.goods_maxnum > 0 && buynum > data.goods_content.goods_maxnum) {
                        ...
                        $.ajax({
                            type:'post',
                            url:ApiUrl+'/index.php/member_buy/buy_step1',
                            data:json,
                            dataType:'json',
                            success:function(result){
                                if (result.datas.error) {
			  ...
			  if (wx_share) {
					...
					$.ajax({
						url: ApiUrl + "/index.php/wx_share?str="+encodeURIComponent(_str)+"&goods_id="+data.goods_content.goods_id,
						data:{key:key},
						dataType: 'script',
						success: function (result) {
						}
  ...
  $('#product_detail_html').on('click', '#get_area_selected', function(){
      $.areaSelected({
          success : function(data){
              ...
              $.getJSON(ApiUrl + '/index.php/goods/calc', {goods_id:goods_id,area_id:area_id},function(result){
...
function virtual() {
    ...
    $.getJSON(ApiUrl + '/index.php/goods/store_o2o_addr', {store_id:store_id},function(result){
    	if (!result.datas.error) {
...
function talert(){
  ...
  $.ajax({
    url: ApiUrl + "/index.php/sharepoint?gid="+goods_id,
    type: 'get',
    data:{key:key2},
    dataType: 'json',
    success: function(result) {
