...
$(function() {
    ...
    $.ajax({
        type: 'post',
        url: ApiUrl + "/index.php/store/store_info",
...
if(data.store_info.mb_store_menu.on == 1){
    ...
    $('#goods_rank_tab').find('a').click(function(){
        ...
        $.ajax({
            type: 'post',
            url: ApiUrl + '/index.php/store/store_goods_rank',
    ...
    function getStoreNewGoods(){
        ...
        load_class_newgoods.loadInit({'url':ApiUrl + '/index.php/store/store_new_goods','getparam':param,'tmplid':'newgoods_tpl','containerobj':$("#newgoods"),'iIntervalId':true,'resulthandle':'tidyStoreNewGoodsData'});
    }
    //加载店铺促销活动
    function getStoreActivity(){
        $.ajax({
            type: 'post',
            url: ApiUrl + "/index.php/store/store_sale",
    ...
    $("#store_voucher").click(function(){
        if (!$("#store_voucher_con").html()) {
            $.ajax({
                type: 'post',
                url: ApiUrl + '/index.php/voucher/voucher_tpl_list',
