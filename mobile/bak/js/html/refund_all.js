...
$(function(){
    ...
    $.getJSON(ApiUrl + '/index.php/member_refund/refund_all_form',{key:key,order_id:getQueryString('order_id')}, function(result) {
        ...
        $('.btn-l').click(function(){
            ...
            $.ajax({//获取区域列表
                type:'post',
                url:ApiUrl+'/index.php/member_refund/refund_all_post',
                data:param,
                dataType:'json',
                async:false,
