...
function get_list() {
	...
	$.getJSON(ApiUrl + "/index.php/news_article/article_list?" + window.location.search.replace("?", "&"), param, function(e) {
		if (!e) {
			e = [];
			e.datas = [];
...
function class_list() {
	...
	$.getJSON(ApiUrl + "/index.php/news_article/class_list", param, function(e) {
		var r = e.datas;
