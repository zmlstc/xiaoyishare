...
CREATE TABLE `#__bbs` (
  ...
  PRIMARY KEY (`bbs_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='社区表';

CREATE TABLE `#__bbs_affix` (
...
CREATE TABLE `#__bbs_fs` (
  ...
  PRIMARY KEY (`bbs_id`,`friendship_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='友情社区表';

CREATE TABLE `#__bbs_inform` (
  ...
  KEY `bbs_id` (`bbs_id`,`theme_id`,`reply_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='社区举报表';

CREATE TABLE `#__bbs_like` (
  `theme_id` int(11) unsigned NOT NULL COMMENT '主题id',
  `member_id` int(11) unsigned NOT NULL COMMENT '会员id',
  `bbs_id` int(11) unsigned NOT NULL COMMENT '社区id'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='主题赞表';

CREATE TABLE `#__bbs_mapply` (
...
CREATE TABLE `#__bbs_member` (
  ...
  PRIMARY KEY (`member_id`,`bbs_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='社区会员表';

CREATE TABLE `#__bbs_ml` (
  `bbs_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '社区id',
...
INSERT INTO `#__bbs_mldefault` (`mld_id`, `mld_name`, `mld_exp`) VALUES
(1, '初级粉丝', 1),
(2, '中级粉丝', 5),
(3, '高级粉丝', 15),
(4, '正式会员', 30),
...
INSERT INTO `#__bbs_mlref` (`mlref_id`, `mlref_name`, `mlref_addtime`, `mlref_status`, `mlref_1`, `mlref_2`, `mlref_3`, `mlref_4`, `mlref_5`, `mlref_6`, `mlref_7`, `mlref_8`, `mlref_9`, `mlref_10`, `mlref_11`, `mlref_12`, `mlref_13`, `mlref_14`, `mlref_15`, `mlref_16`) VALUES
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='社区回收站表';

CREATE TABLE `#__bbs_thclass` (
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='社区主题分类表';

CREATE TABLE `#__bbs_theme` (
  ...
  PRIMARY KEY (`theme_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='社区主题表';

CREATE TABLE `#__bbs_thg` (
...
CREATE TABLE `#__bbs_thpolloption` (
...
CREATE TABLE `#__bbs_thpollvoter` (
  `theme_id` int(11) unsigned NOT NULL COMMENT '话题id',
  `member_id` int(11) unsigned NOT NULL COMMENT '成员id',
  `member_name` varchar(50) NOT NULL COMMENT '成员名称',
