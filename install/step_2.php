...
$(document).ready(function(){
    $('#next').on('click',function(){
        if (typeof($('.no').html()) == 'undefined'){
            $(this).attr('href','index.php?step=3');
        }else{
...
<div class="main">
  ...
  <div class="content-box">
    <table width="100%" border="0" cellspacing="2" cellpadding="0">
      ...
      <tr>
        <th scope="col">项目</th>
        <th width="25%" scope="col">ShopWT所需</th>
  ...
  <div class="btn-box"><a href="index.php?step=1" class="btn">上一步</a><a href='###' id="next" class="btn btn-primary">下一步</a></div>
</div>
