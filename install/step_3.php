...
<script type="text/javascript" src="../system/static/js/jquery.validation.min.js"></script>
<script type="text/javascript" src="../system/static/js/jquery.icheck.min.js"></script>
<script>
...
<div class="main">
  ...
  <form action="" id="install_form" method="post">
    ...
    <div class="form-box control-group">
      <fieldset>
        ...
        <div>
          <label>数据库名</label>
          <span>
          <input type="text" name="db_name" maxlength="50" value="<?php echo $_POST['db_name'] ? $_POST['db_name'] : 'shopwt';?>">
          </span> <em>例如'shopwt'或'my_shopwt',请确保用字母开头</em></div>
        <div>
          <label>数据库用户名</label>
          <span>
        ...
        <div>
          <label>数据库表前缀</label>
          <span>
          <input type="text" name="db_prefix" maxlength="30" value="<?php echo $_POST['db_prefix'] ? $_POST['db_prefix'] : 'shopwt_';?>">
          </span> <em>例如：shopwt_ 请不要留空，且使用“_”结尾，建议使用默认</em></div>
        <div>
          <label>数据库端口</label>
          <span>
    ...
    <div class="btn-box"><a href="index.php?step=2" class="btn">上一步</a><a id="next" href="javascript:void(0);" class="btn btn-primary">下一步</a></div>
  </form>
</div>
