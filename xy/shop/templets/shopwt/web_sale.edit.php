...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base wt-row">
        <li><a href="<?php echo urlAdminShop('page_config','page_config');?>"><?php echo '板块区';?></a></li>
        <li><a href="<?php echo urlAdminShop('page_config','focus_edit');?>"><?php echo '焦点区';?></a></li>
  ...
  <form id="sale_list_form" method="post" name="form1">
    ...
    <div class="wtap-form-default">
      ...
      <div class="bot"><a href="<?php echo urlAdminShop('page_config','html_update',array('web_id'=>$output['code_sale_list']['web_id']));?>" class="wtap-btn-big wtap-btn-green"><?php echo $lang['page_config_web_html'];?></a></div>
    </div>
  </form>
</div>
      ...
      <dd class="opt">
        <ul class="dialog-goodslist-s1 goods-list">
          ...
          <li>
            ...
            <div class="goods-name"><a href="<?php echo urlShop('goods','',array('goods_id'=>$v['goods_id']));?>" target="_blank"><?php echo $v['goods_name'];?></a></div>
          </li>
          <?php } ?>
          <?php } ?>
        </ul>
