...
<div class="page">
  ...
  <div class="wtap-search-bar">
    ...
    <form method="get" action="<?php echo urlAdminShop('stat_member','analyze');?>" name="formSearch" id="formSearch">
...
$(function() {
    ...
    $("#list_ordernum").flexigrid({
        url: '<?php echo urlAdminShop('stat_member','get_analyzeinfo_xml',array('type'=>'ordernum','c'=>$output['searchtime']));?>',
        colModel : [
    ...
    $("#list_orderamount").flexigrid({
        url: '<?php echo urlAdminShop('stat_member','get_analyzeinfo_xml',array('type'=>'orderamount','c'=>$output['searchtime']));?>',
        colModel : [
            {display: '操作', name : 'operation', width : 60, sortable : false, align: 'center', className: 'handle-s'},
            {display: '序号', name : 'number', width : 100, sortable : false, align: 'center'},
            {display: '会员名称', name : 'statm_membername',  width : 150, sortable : false, align: 'center'},
    ...
    $("#list_goodsnum").flexigrid({
        url: '<?php echo urlAdminShop('stat_member','get_analyzeinfo_xml',array('type'=>'goodsnum','c'=>$output['searchtime']));?>',
        colModel : [
            {display: '操作', name : 'operation', width : 60, sortable : false, align: 'center', className: 'handle-s'},
            {display: '序号', name : 'number', width : 100, sortable : false, align: 'center'},
            {display: '会员名称', name : 'statm_membername',  width : 150, sortable : false, align: 'center'},
...
function fg_operation_excel(stat_type,obj){
    var stat_url = '<?php echo urlAdminShop('stat_member','analyzeinfo',array('exporttype'=>'excel','c'=>$output['searchtime']));?>?type='+stat_type;
