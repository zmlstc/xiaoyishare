...
<div class="page">
  ...
  <div class="wtap-stat-chart">
    <div class="title">
      <h3>客单价分布图</h3>
      <h5><a href="<?php echo urlAdminShop('stat_general','orderprange');?>"  class="wtap-btn">设置价格区间</a></h5>
    </div>
    <?php if ($output['guestprice_statjson']){ ?>
    <div id="container_guestprice" style="height:400px"></div>
    <?php } else { ?>
    <div class="no-date">查看客单价分布情况前，请先设置价格区间。<a href="<?php echo urlAdminShop('stat_general','orderprange');?>" class="wtap-btn wtap-btn-orange">马上设置</a></div>
    <?php }?>
  </div>
  ...
  <div class="wtap-search-bar">
    ...
    <form method="get" action="<?php echo urlAdminShop('stat_member','buying');?>" name="formSearch" id="formSearch">
