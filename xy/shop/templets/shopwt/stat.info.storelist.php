...
$(function(){
    $("#flexigrid").flexigrid({
        url: '<?php echo urlAdminShop('stat_store','get_store_xml',array('provid'=>$_GET['provid'],'scid'=>$_GET['scid'],'c'=>$_GET['c']));?>',
        colModel : [
            {display: '操作', name : 'operation', width : 60, sortable : false, align: 'center', className: 'handle-s'},
            {display: '店铺名称', name : 'store_name', width : 150, sortable : false, align: 'center'},
            {display: '会员账号', name : 'member_name',  width : 120, sortable : false, align: 'center'},
...
function fg_operation(name, bDiv){
    var stat_url = '<?php echo urlAdminShop('stat_store','showstore',array('exporttype'=>'excel','provid'=>$_GET['provid'],'scid'=>$_GET['scid'],'c'=>$_GET['c']));?>';
