...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="<?php echo urlAdminShop('help_store','help_store');?>" title="返回列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
...
$(function(){
    ...
    $('#fileupload').each(function(){
        $(this).fileupload({
            dataType: 'json',
            url: '<?php echo urlAdminShop('help_store','upload_pic',array('item_id'=>$output['help']['help_id']));?>',
...
function del_file_upload(file_id){
    ...
    $.getJSON('<?php echo urlAdminShop('help_store','del_pic');?>?file_id=' + file_id, function(result){
        if(result){
            $('#pic_' + file_id).remove();
        }
    });
