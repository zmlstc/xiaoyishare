  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base wt-row">
        ...
        <li><a href="<?php echo urlAdminShop('pointprod','pointorder_list');?>" ><?php echo $lang['admin_pointorder_list_title'];?></a></li>
      </ul>
    </div>
  </div>
  <!-- 操作说明 -->
...
<script>
$(function(){
    var flexUrl = '<?php echo urlAdminShop('pointprod','pointprod_xml');?>';
        ...
        buttons: [
            {
                ...
                title: '新增积分兑换礼品',
                onpress: function() {
                    location.href = '<?php echo urlAdminShop('pointprod','prod_add');?>';
                }
            },
            {
