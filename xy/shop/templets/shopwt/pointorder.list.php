  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base wt-row">
        <li><a href="<?php echo urlAdminShop('pointprod','pointprod');?>" ><span><?php echo $lang['admin_pointprod_list_title'];?></span></a></li>
...
<script>
$(function() {
    var flexUrl = '<?php echo urlAdminShop('pointprod','pointorder_list_xml');?>';
