  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base wt-row">
        <li><a href="<?php echo urlAdminShop('points','pointslog');?>"><?php echo $lang['admin_points_log_title']?></a></li>
        <li><a href="JavaScript:void(0);" class="current">规则设置</a></li>
        <li><a href="<?php echo urlAdminShop('points','addpoints');?>">积分增减</a></li>
      </ul>
    </div>
  </div>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input id="points_comments" name="points_comments" value="<?php echo $output['list_setting']['points_comments'];?>" class="input-txt" type="text">
	  	 ...
	  	 <dl class="row">
        <dt class="tit">会员消费返积分比</dt>
        <dd class="opt">
          消费1元 =<input id="cost_points_bl" name="cost_points_bl" value="<?php echo $output['list_setting']['cost_points_bl'];?>" class="txt" type="text" style="width:60px;">积分
          <p class="notic"></p>
        </dd>
      </dl>
