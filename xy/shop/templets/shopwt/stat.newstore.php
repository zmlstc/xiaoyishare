...
<div class="page">
  ...
  <table class="flex-table">
    ...
    <tbody id="datatable">
      ...
      <tr>
        ...
        <td class="handle-s"><a href="<?php echo urlAdminShop('stat_store','showstore',array('type'=>'newbyday','c'=>$v['seartime'],'scid'=>$_REQUEST['search_sclass']));?>" class="btn green"><i class="fa fa-list-alt"></i>查看</a></td>
  ...
  <div class="wtap-search-bar">
    ...
    <form method="get" action="<?php echo urlAdminShop('stat_store','newstore');?>" name="formSearch" id="formSearch">
