...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="<?php echo urlAdminShop('predeposit','predeposit');?>" title="返回充值管理列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
  ...
  <form method="post" name="form1" id="form1" action="<?php echo urlAdminShop('predeposit','recharge_edit',array('id'=>intval($_GET['id'])));?>">
