...
function update_flex(){
	$('.wtap-stat-general-single').load('<?php echo urlAdminShop('stat_trade','get_plat_income');?>?'+$("#formSearch").serialize(),
		function(){
			$('.timer').each(count);
     	});

    $("#flexigrid").flexigrid({
        url: '<?php echo urlAdminShop('stat_trade','get_income_xml');?>?'+$("#formSearch").serialize(),
        colModel : [
...
function fg_operation(name, bDiv){
    var stat_url = '<?php echo urlAdminShop('stat_trade','income');?>';
