...
<script>
$(function(){
    var flexUrl = '<?php echo urlAdminShop('activity','activity_xml');?>';
        ...
        buttons: [
            {
                ...
                title: '平台发起新活动',
                onpress: function() {
                    location.href = '<?php echo urlAdminShop('activity','new');?>';
                }
            },
            {
                ...
                onpress: function() {
                    ...
                    var href = '<?php echo urlAdminShop('activity','del');?>?activity_id=__IDS__'.replace('__IDS__', ids.join(','));
...
$("span[data-live-inline-edit='activity_sort']").live('click', function() {
    ...
    $input.change(function() {
        ...
        $.get('<?php echo urlAdminShop('activity','ajax',array('branch'=>'activity_sort'));?>', {
...
$("span[data-live-inline-edit='activity_title']").live('click', function() {
    ...
    $input.change(function() {
        ...
        $.get('<?php echo urlAdminShop('activity','ajax',array('branch'=>'activity_title'));?>', {
            id: $this.parents('tr').attr('data-id'),
