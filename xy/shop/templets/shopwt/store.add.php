...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="<?php echo urlAdminShop('store','list');?>" title="返回列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
    ...
    <div class="wtap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          ...
          <span class="err"></span>
          <p class="notic">用于登录商家中心，可与会员账号不同</p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
    ...
    $('#store_form').validate({
        ...
        rules : {
            ...
            member_name: {
                ...
                maxlength : 15,
                remote   : {
                    url : '<?php echo urlAdminShop('ownshop','check_member_name');?>',
                    type: 'get',
                    data:{
            ...
            seller_name: {
                ...
                maxlength : 15,
                remote   : {
                    url : '<?php echo urlAdminShop('ownshop','check_seller_name');?>',
                    type: 'get',
                    data:{
