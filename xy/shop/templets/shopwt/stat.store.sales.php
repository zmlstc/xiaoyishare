...
function getTrends(storeid){
	var s_type = $("#search_type").val();
	$('#stattrends').load('<?php echo urlAdminShop('stat_store','storesales_trends');?>?storeid='+storeid+'&search_type='+s_type+'&'+$("#formSearch").serialize());
}
function update_flex(){
    $('#stattrends').html('');
    $("#flexigrid").flexigrid({
        url: '<?php echo urlAdminShop('stat_store','get_storesales_xml');?>?'+$("#formSearch").serialize(),
        colModel : [
...
function fg_operation(name, bDiv){
    var stat_url = '<?php echo urlAdminShop('stat_store','storesales_list');?>';
