...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <a class="back" href="<?php echo urlAdminShop('plat_act','act_sub',array('act_id'=>$output['act_id']));?>" title="返回子活动列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
  ...
  <form id="add_form" method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" name="act_id" id="act_id" value="<?php echo $output['act_id'];?>" />
