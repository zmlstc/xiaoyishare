...
<div class="page">
  ...
  <div class="wtap-search-bar">
    ...
    <form method="get" action="<?php echo urlAdminShop('stat_store','hotrank');?>" name="formSearch" id="formSearch">
...
function getStatdata(type){
	...
	$('#'+type+'_div').load('<?php echo urlAdminShop('stat_store','hotrank_list',array('c'=>$output['searchtime']));?>?type='+type+'&search_sclass='+search_sclass);
}
</script>