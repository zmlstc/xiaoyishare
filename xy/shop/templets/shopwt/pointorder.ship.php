...
<div class="page">
  ...
  <form id="ship_form" method="post" name="ship_form" action="<?php echo urlAdminShop('pointprod','order_ship',array('id'=>$_GET['id']));?>">
  ...
  <div class='msgdiv'> <?php echo $output['errormsg']; ?> <br>
    <br>
    <a class="forward" href="<?php echo urlAdminShop('pointprod','pointorder_list');?>"><?php echo $lang['admin_pointorder_gobacklist']; ?></a> </div>
  <?php } ?>
</div>
