  ...
  <form id="pointprod_form" method="post" enctype="multipart/form-data" >
    ...
    <div class="wtap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" name="store_id" id="store_id" class="input-txt" value="<?php echo $output['prod_info']['store_id']; ?>"/>
          <span class="err"></span>
          <p class="notic">商家店铺对应的数字ID</p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
...
//
    $('#pointprod_form').validate({
        ...
        rules : {
            store_id: {
                ...
                min       : 0,
				remote   : {
                    url :'<?php echo urlAdminShop('store','ckeck_storeid');?>',
                    type:'get',
                    data:{
                        store_id : function(){
                            return $('#store_id').val();
        ...
        messages : {
            store_id : {
				required : '<i class="fa fa-exclamation-bbs"></i>请输入商家店铺ID',
                number   : '<i class="fa fa-exclamation-bbs"></i>请输入商家店铺的数字ID',
                min     : '<i class="fa fa-exclamation-bbs"></i>店铺ID不正确',
				remote   : '<i class="fa fa-exclamation-bbs"></i>店铺不存在，请重新输入'
            },
        	goodsname  : {
    ...
    $('#fileupload').each(function(){
        $(this).fileupload({
            dataType: 'json',
            url: '<?php echo urlAdminShop('pointprod','pointprod_pic_upload',array('item_id'=>$output['prod_info']['pgoods_id']));?>',
...
function del_file_upload(file_id)
{
    ...
    $.getJSON('<?php echo urlAdminShop('pointprod','ajaxdelupload');?>?file_id=' + file_id, function(result){
        if(result){
            $('#' + file_id).remove();
        }else{
