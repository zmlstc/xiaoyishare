...
<div class="page">
  ...
  <form id="act_class_form" method="post">
    ...
    <div class="wtap-form-default">
      <dl class="row">
        <dt class="tit">
          <label class="gc_name"><em>*</em><?php echo $lang['store_class_name'];?></label>
        </dt>
        <dd class="opt">
          <input type="text" value="<?php echo $output['class_array']['gc_name'];?>" name="gc_name" id="gc_name" class="input-txt">
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" value="<?php echo $output['class_array']['gc_sort'];?>" name="gc_sort" id="gc_sort" class="input-txt">
          <span class="err"></span>
