...
<div class="page">
  ...
  <table class="flex-table">
    ...
    <tbody id="datatable">
      ...
      <tr>
        ...
        <td class="handle-s"><a href="<?php echo urlAdminShop('stat_member','showmember',array('type'=>'newbyday','c'=>$v['searchtime']));?>" class="btn green"><i class="fa fa-list-alt"></i>查看</a></td>
      ...
      <tr>
        <td class="sign"><i class="ico-check"></i></td>
        <td class="handle-s"><a href="<?php echo urlAdminShop('stat_member','showmember',array('type'=>'newbyday','c'=>$output['count_arr']['seartime']));?>" class="btn green"><i class="fa fa-list-alt"></i>查看</a></td>
        <td><b>总计</b></td>
  ...
  <div class="wtap-search-bar">
    ...
    <form method="get" action="<?php echo urlAdminShop('stat_member','newmember');?>" name="formSearch" id="formSearch">
