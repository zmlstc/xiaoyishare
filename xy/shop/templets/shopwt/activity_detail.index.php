...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <a class="back" href="<?php echo urlAdminShop('activity','activity');?>" title="返回活动列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
...
<script>
$(function(){
    var flexUrl = '<?php echo urlAdminShop('activity','detail_xml',array('id'=>$output['activity_detail']['activity_id']));?>';
        ...
        buttons: [
            {
                ...
                onpress: function() {
                    ...
                    var href = '<?php echo urlAdminShop('activity','deal',array('state'=>'1'));?>?activity_detail_id=__IDS__'.replace('__IDS__', ids.join(','));
                    performReq(href);
                }
            },
            {
                ...
                onpress: function() {
                    ...
                    var href = '<?php echo urlAdminShop('activity','deal',array('state'=>'2'));?>?activity_detail_id=__IDS__'.replace('__IDS__', ids.join(','));
                    performReq(href);
                }
            },
            {
                ...
                onpress: function() {
                    ...
                    var href = '<?php echo urlAdminShop('activity','del_detail');?>?activity_detail_id=__IDS__'.replace('__IDS__', ids.join(','));
                    performReq(href);
                }
            }
        ],
...
$("span[data-live-inline-edit='activity_detail_sort']").live('click', function() {
    ...
    $input.change(function() {
        ...
        $.get('<?php echo urlAdminShop('activity','ajax',array('branch'=>'activity_detail_sort'));?>', {
