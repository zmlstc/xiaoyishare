...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="<?php echo urlAdminShop('help_store','help_type');?>" title="返回列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
  ...
  <form id="post_form" method="post" name="form1" action="<?php echo urlAdminShop('help_store','edit_type',array('type_id'=>$output['type']['type_id']));?>">
