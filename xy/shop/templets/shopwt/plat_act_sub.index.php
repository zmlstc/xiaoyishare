...
<script>
$(function(){
    var flexUrl = '<?php echo urlAdminShop('plat_act','act_sub_xml',array('act_id'=>$output['act_id']));?>';
        ...
        buttons: [
            {
                ...
                title: '平台发起新活动',
                onpress: function() {
                    location.href = '<?php echo urlAdminShop('plat_act','new2',array('act_id'=>$output['act_id']));?>';
                }
            },
            {
