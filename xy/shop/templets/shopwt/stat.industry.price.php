...
<div class="page">
  ...
  <div class="wtap-stat-chart">
    <div class="title">
      <h3>行业价格分布图</h3>
      <h5><a href="<?php echo urlAdminShop('stat_general','setting');?>" class="wtap-btn">设置价格区间</a></h5>
    </div>
    ...
    <?php } else {?>
    <div class="no-date"><i class="fa fa-exclamation-triangle"></i>查看行业价格分布情况前，请先设置价格区间。<a href="<?php echo urlAdminShop('stat_general','setting');?>" class="wtap-btn wtap-btn-orange">马上设置</a></div>
    <?php } ?>
  </div>
  ...
  <div class="wtap-search-bar">
    ...
    <form method="get" action="<?php echo urlAdminShop('stat_industry','price');?>" name="formSearch" id="formSearch">
