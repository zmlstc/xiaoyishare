...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="<?php echo urlAdminShop('sns_malbum','class_list');?>" title="返回<?php echo $lang['snsalbum_class_list'];?>"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
  ...
  <form method='post' id="form_pic">
    ...
    <ul class="wtap-thumb-list">
      ...
      <li class="picture">
        ...
        <a href="javascript:void(0);" onclick="if(confirm('<?php echo $lang['wt_ensure_del'];?>')){location.href='<?php echo urlAdminShop('sns_malbum','del_pic',array('id'=>$val['ap_id']));?>';}else{return false;}" class="del" title="<?php echo $lang['wt_del'];?>">X</a> </li>
      <?php } ?>
    </ul>
    <?php }else { ?>
