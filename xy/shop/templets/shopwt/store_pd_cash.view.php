<?php defined('ShopWT') or exit('Access Denied By ShopWT');?>
  <div class="wtap-form-default">
    ...
    <dl class="row">
      ...
      <dd class="opt"><?php echo $output['info']['pdc_store_name']; ?>
        <p class="notic"></p>
      </dd>
    </dl>
    <dl class="row">
    ...
    <div class="bot" id="submit-holder"> <a class="wtap-btn-big wtap-btn-green" href="javascript:if (confirm('您确认已将提现金额支付到商家提现账户吗？')){window.location.href='<?php echo urlAdminShop('store_predeposit','pd_cash_pay',array('id'=>$output['info']['pdc_id']));?>';}else{}"><?php echo $lang['admin_predeposit_payed'];?></a></div>
  <?php } ?>
  </div>