...
function update_flex(){
	$('.wtap-stat-general-single').load('<?php echo urlAdminShop('stat_trade','get_plat_predeposit');?>?'+$("#formSearch").serialize(),
		function(){
			$('.timer').each(count);
     	});
	$('#container').load('<?php echo urlAdminShop('stat_trade','get_predeposit_highcharts');?>?'+$("#formSearch").serialize());
    $("#flexigrid").flexigrid({
        url: '<?php echo urlAdminShop('stat_trade','get_predeposit_xml');?>?'+$("#formSearch").serialize(),
        colModel : [
...
function fg_operation(name, bDiv){
    var stat_url = '<?php echo urlAdminShop('stat_trade','predeposit');?>';
