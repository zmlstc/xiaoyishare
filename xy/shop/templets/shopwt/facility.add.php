...
<div class="page">
  ...
  <form id="facility_form" method="post"  enctype="multipart/form-data" >
    ...
    <div class="wtap-form-default">
      <dl class="row">
        <dt class="tit">
          <label for="f_name"><em>*</em>名称</label>
        </dt>
        <dd class="opt">
	  ...
	  <dl class="row">
        ...
        <dd class="opt">
          ...
          <div class="input-file-show"><span class="type-file-box">
            <input type="file" class="type-file-file" id="change_f_img" name="f_img" size="30" hidefocus="true"  wt_type="change_f_img" title="点击按钮选择文件并提交表单后上传生效">
            </span></div></div>
          <span class="err"></span>
        ...
        <dd class="opt">
          <div id="gcategory">
            <select class="class-select" name="fc_id" id="fc_id">
              ...
              <option value="<?php echo $v['fc_id'];?>"><?php echo $v['fc_name'];?></option>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" value="255" name="f_sort" id="f_sort" class="input-txt">
          <span class="err"></span>
...
$(document).ready(function(){
	$('#facility_form').validate({
        ...
        messages : {
            ...
            f_img: {
        		required : '<i class="fa fa-exclamation-bbs"></i>图标不能为空',
