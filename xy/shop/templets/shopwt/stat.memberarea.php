...
<div class="page">
  ...
  <div class="wtap-search-bar">
    ...
    <form method="get" action="<?php echo urlAdminShop('stat_member','area');?>" name="formSearch" id="formSearch">
...
$(function () {
    ...
    //加载统计列表
    $("#statlist").flexigrid({
        url: '<?php echo urlAdminShop('stat_member','get_arealist_xml',array('c'=>$output['searchtime']));?>',
        colModel : [
