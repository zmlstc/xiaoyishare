...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="<?php echo urlAdminShop('store_class');?>" title="返回列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
    ...
    <div class="wtap-form-default">
	 <dl class="row">
	  ...
	  <dl class="row">
        ...
        <dd class="opt">
          <input id="commis_rate_invstore" class="w60" type="text" value="<?php echo $output['class_array']['commis_rate_invstore'];?>" name="commis_rate_invstore">
          <i>%</i> <span class="err"></span>
          <p class="notic mb10">比例必须为0-100的数字，支持小数点后2位。</p>
	  ...
	  <dl class="row">
        ...
        <dd class="opt">
          <input id="commis_rate_invmember" class="w60" type="text" value="<?php echo $output['class_array']['commis_rate_invmember'];?>" name="commis_rate_invmember">
          <i>%</i> <span class="err"></span>
          <p class="notic mb10">比例必须为0-100的数字，支持小数点后2位。</p>
	  ...
	  <dl class="row">
        ...
        <dd class="opt">
          <input id="commis_rate_system" class="w60" type="text" value="<?php echo $output['class_array']['commis_rate_system'];?>" name="commis_rate_system">
          <i>%</i> <span class="err"></span>
          <p class="notic mb10">比例必须为0-100的数字，支持小数点后2位。</p>
	  ...
	  <dl class="row">
        ...
        <dd class="opt">
          <input id="commis_rate_points" class="w60" type="text" value="<?php echo $output['class_array']['commis_rate_points'];?>" name="commis_rate_points">
          <i>%</i> <span class="err"></span>
          <p class="notic mb10">比例必须为0-100的数字，支持小数点后2位。</p>
         ...
         <div id="spec_div" class="scrollbar-box">
            ...
            <div class="wtap-type-spec-list">
              <?php foreach($output['f_list'] as $k=>$val){?>             
                  <label>
                    <input class="checkitem" wt_type="change_default_fc_value" type="checkbox" value="<?php echo $val['fc_id'];?>" name="fc_id[]" <?php if(in_array($val['fc_id'],$output['facility_ids'])){ echo 'checked=checked';} ?>>
