...
<div class="page">
  ...
  <form id="facility_class_form" method="post">
    ...
    <div class="wtap-form-default">
      <dl class="row">
        <dt class="tit">
          <label for="fc_name"><em>*</em>分类名称</label>
        </dt>
        <dd class="opt">
          <input type="text" value="" name="fc_name" id="fc_name" class="input-txt">
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" value="255" name="fc_sort" id="fc_sort" class="input-txt">
          <span class="err"></span>
