  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base wt-row">
        <li><a href="<?php echo urlAdminShop('store_predeposit','pd_cash_list');?>"><?php echo $lang['admin_predeposit_cashmanage']; ?></a></li>
...
$(function(){
    $("#flexigrid").flexigrid({
        url: '<?php echo urlAdminShop('store_predeposit','get_log_xml');?>',
        colModel : [
            {display: '操作', name : 'operation', width : 60, sortable : false, align: 'center', className: 'handle-s'},
            {display: '日志ID', name : 'lg_id', width : 40, sortable : true, align: 'center'},
            {display: '店铺ID', name : 'lg_store_id', width : 40, sortable : true, align: 'center'},
            {display: '店铺名称', name : 'lg_store_name', width : 230, sortable : true, align: 'center'},
        ...
        searchitems : [
            ...
            {display: '店铺ID', name : 'lg_store_id'},
            {display: '店铺名称', name : 'lg_store_name'},
