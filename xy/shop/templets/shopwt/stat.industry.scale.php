...
<div class="page">
  ...
  <div class="wtap-search-bar">
    ...
    <form method="get" action="<?php echo urlAdminShop('stat_industry','scale');?>" name="formSearch" id="formSearch">
...
function getStatdata(type){
	...
	$('#'+type+'_div').load('<?php echo urlAdminShop('stat_industry','scale_list',array('c'=>$output['searchtime']));?>?stattype='+type+'&choose_gcid='+choose_gcid);
}
</script>