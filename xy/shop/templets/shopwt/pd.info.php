...
<div class="wtap-form-default">
  ...
  <div class="bot"><a  class="wtap-btn-big wtap-btn-green" href="<?php echo urlAdminShop('predeposit','recharge_edit',array('id'=>$output['info']['pdr_id']));?>"><span><?php echo  $lang['admin_predeposit_payed'];?></span></a></div>
  <?php } ?>
</div>
