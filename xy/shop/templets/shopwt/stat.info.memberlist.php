...
$(function(){
    $("#flexigrid").flexigrid({
        url: '<?php echo urlAdminShop('stat_member','get_member_xml',array('c'=>$_GET['c']));?>',
        colModel : [
...
function fg_operation(name, bDiv){
    var stat_url = '<?php echo urlAdminShop('stat_member','showmember',array('exporttype'=>'excel','c'=>$_GET['c']));?>';
