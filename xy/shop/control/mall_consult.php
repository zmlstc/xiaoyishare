    ...
    public function get_xmlWt(){
        ...
        foreach ($consult_list as $consult_info) {
            ...
            if ($consult_info['is_reply']) {
                $list['operation'] .= "<a class=\"btn green\" href=\"".urlAdminShop('mall_consult','consult_reply',array('id'=>$consult_info['mc_id']))."\"><i class=\"fa fa-list-alt\"></i>编辑</a>";
            } else {
                $list['operation'] .= "<a class=\"btn green\" href=\"".urlAdminShop('mall_consult','consult_reply',array('id'=>$consult_info['mc_id']))."\"><i class=\"fa fa-list-alt\"></i>回复</a>";
            }
