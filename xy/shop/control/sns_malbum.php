...
class sns_malbumControl extends SystemControl{
    ...
    public function get_xmlWt() {
        ...
        foreach ($ac_list as $value) {
            $param = array();
            $param['operation'] = "<a class='btn green' href='".urlAdminShop('sns_malbum','pic_list',array('id'=>$value['ac_id']))."' class='url'><i class='fa fa-list-alt'></i>查看</a>";
            ...
            $param['ac_cover'] = "<a href='javascript:void(0);' class='pic-thumb-tip' onMouseOut='toolTip()' onMouseOver='toolTip(\"<img src=".($value['ac_cover'] != '' ? UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$value['member_id'].DS.$value['ac_cover'] : ADMIN_SITE_URL.'/templets/'.TPL_NAME.'/images/member/pic-default.png').">\")'><i class='fa fa-picture-o'></i></a>";
