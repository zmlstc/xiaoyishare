...
class stat_storeControl extends SystemControl{
    private $links = array(
        array('url'=>'stat_store/newstore','lang'=>'stat_newstore'),
        array('url'=>'stat_store/hotrank','lang'=>'stat_storehotrank'),
        array('url'=>'stat_store/storesales','lang'=>'stat_storesales'),
        array('url'=>'stat_store/degree','lang'=>'stat_storedegree'),
        array('url'=>'stat_store/storearea','lang'=>'stat_storearea'),
    );
    ...
    public function newstoreWt(){
        //导出excel连接地址
        $actionurl = urlAdminShop('stat_store','newstore');
        $where = array();
        //所属店铺分类
    ...
    public function showstoreWt(){
        ...
        $this->links[] = array('url'=>'stat_store/showstore','lang'=>'stat_storelist');
    ...
    public function storeareaWt(){
        ...
        Tpl::output('stat_json',$stat_json);
        Tpl::output('statlist',$statlist);
        $actionurl = urlAdminShop('stat_store','showstore',array('type'=>'storearea'));
        if (trim($_GET['search_time'])){
