...
class stat_generalControl extends SystemControl{
    private $links = array(
        array('url'=>'stat_general/general','lang'=>'stat_generalindex'),
        array('url'=>'stat_general/setting','lang'=>'stat_goodspricerange'),
        array('url'=>'stat_general/orderprange','lang'=>'stat_orderpricerange')
    );
