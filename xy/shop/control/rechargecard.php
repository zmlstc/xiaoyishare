...
class rechargecardControl extends SystemControl
{
    ...
    public function index_xmlWt()
    {
        ...
        foreach ($list as $val) {
            ...
            $i['operation'] = $isUsed ? '--' : '<a class="btn green confirm-del-on-click" href="javascript:;" data-href="'.urlAdminShop('rechargecard','del_card',array('id'=>$val['id'])).'"><i class="fa fa-trash"></i>删除</a>';
    ...
    public function export_step1Wt()
    {
        ...
        if (!is_numeric($_GET['curpage'])) {
            ...
            if ($count > self::EXPORT_SIZE) {
                ...
                Tpl::output('murl', urlAdminShop('rechargecard'));
				Tpl::setDirquna('shop');
    ...
    public function log_export_step1Wt()
    {
        ...
        if (!is_numeric($_GET['curpage'])){
            ...
            if ($count > self::EXPORT_SIZE ){
                ...
                Tpl::output('list',$array);
                Tpl::output('murl',urlAdminShop('rechargecard','log_list'));
				Tpl::setDirquna('shop');
                Tpl::showpage('export.excel');
                return;
