...
class orderControl extends SystemControl{
    ...
    public function get_xmlWt(){
        ...
        foreach ($order_list as $order_id => $order_info) {
            ...
            $list['operation'] = "<a class=\"btn green\" href=\"".urlAdminShop('order','show_order',array('order_id'=>$order_info['order_id']))."\"><i class=\"fa fa-list-alt\"></i>查看</a>";
   ...
   /**
    ...
    public function show_orderWt(){
        ...
        $model_order    = Model('store_order');
        $order_info = $model_order->getOrderInfo(array('order_id'=>$order_id),array('store'));
    ...
    public function export_step1Wt(){
        ...
        if (!is_numeric($_GET['curpage'])){
            ...
            if ($count > self::EXPORT_SIZE ){   //显示下载链接
                ...
                Tpl::output('murl',urlAdminShop('order'));
		Tpl::setDirquna('shop');
