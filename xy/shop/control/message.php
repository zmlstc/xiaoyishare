...
class messageControl extends SystemControl{
    private $links = array(
        array('url'=>'message/seller_tpl', 'lang'=>'seller_tpl'),
        array('url'=>'message/member_tpl', 'lang'=>'member_tpl'),
    );
    ...
    public function seller_tpl_editWt() {
        ...
        $this->links[] = array('url'=>'message/seller_tpl_edit','lang'=>'seller_tpl_edit');
    ...
    public function member_tpl_editWt() {
        ...
        $this->links[] = array('url'=>'message/member_tpl_edit','lang'=>'member_tpl_edit');
