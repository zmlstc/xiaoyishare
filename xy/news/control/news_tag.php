...
Tpl::showpage('news_tag.add');
    ...
    public function news_tag_saveWt() {
        ...
        if($result) {
            ...
            showMessage(Language::get('tag_add_success'),urlAdminCms('news_tag','news_tag_list'));
        } else {
            $this->log(Language::get('news_log_tag_save').$result, 0);
            showMessage(Language::get('tag_add_fail'),urlAdminCms('news_tag','news_tag_list'),'','error');
        }
    ...
    private function show_menu($menu_key) {
        $menu_array = array(
            'list'=>array('menu_type'=>'link','menu_name'=>Language::get('wt_list'),'menu_url'=>urlAdminCms('news_tag','news_tag_list')),
            'add'=>array('menu_type'=>'link','menu_name'=>Language::get('wt_new'),'menu_url'=>urlAdminCms('news_tag','news_tag_add')),
        );
