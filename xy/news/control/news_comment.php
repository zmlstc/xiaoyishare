...
Tpl::showpage('news_comment.manage');
    ...
    public function comment_manage_xmlWt()
    {
        ...
        foreach ($list as $val) {
            ...
            $o = '<a class="btn red confirm-del-on-click" href="'.urlAdminCms('news_comment','comment_drop',array('comment_id'=>$val['comment_id'])).
                '"><i class="fa fa-trash"></i>删除</a>';
            $o .= '<a class="btn green" target="_blank" href="'.urlNews($channel['key'],$channel['key'].'_detail',array($channel['key'].'_id'=>$val['comment_object_id'])).
