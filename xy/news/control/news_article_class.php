...
Tpl::showpage('news_article_class.add');
    ...
    public function news_article_class_saveWt() {
        ...
        if($result) {
            ...
            showMessage(Language::get('class_add_success'),urlAdminCms('news_article_class','news_article_class_list'));
        } else {
            $this->log(Language::get('news_log_article_class_save').$result, 0);
            showMessage(Language::get('class_add_fail'),urlAdminCms('news_article_class','news_article_class_list'),'','error');
        }
    ...
    private function show_menu($menu_key) {
        $menu_array = array(
            'list'=>array('menu_type'=>'link','menu_name'=>Language::get('wt_list'),'menu_url'=>urlAdminCms('news_article_class','news_article_class_list')),
            'add'=>array('menu_type'=>'link','menu_name'=>Language::get('wt_new'),'menu_url'=>urlAdminCms('news_article_class','news_article_class_add')),
        );
