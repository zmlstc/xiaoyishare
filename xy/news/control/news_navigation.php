...
Tpl::showpage('news_navigation.add');
    ...
    public function news_navigation_saveWt() {
        ...
        if($result) {
            ...
            showMessage(Language::get('navigation_add_success'),urlAdminCms('news_navigation','news_navigation_list'));
        } else {
            $this->log(Language::get('news_log_navigation_save').$result, 0);
            showMessage(Language::get('navigation_add_fail'),urlAdminCms('news_navigation','news_navigation_list'),'','error');
        }
    ...
    private function show_menu($menu_key) {
        $menu_array = array(
            'list'=>array('menu_type'=>'link','menu_name'=>Language::get('wt_list'),'menu_url'=>urlAdminCms('news_navigation','news_navigation_list')),
            'add'=>array('menu_type'=>'link','menu_name'=>Language::get('wt_new'),'menu_url'=>urlAdminCms('news_navigation','news_navigation_add')),
        );
