...
Tpl::showpage("news_picture.list");
    ...
    public function news_picture_list_xmlWt()
    {
        ...
        foreach ($list as $val) {
            ...
            $o .= '<li><a target="_blank" href="' .urlNews('picture','picture_detail',array('picture_id'=>$val['picture_id'])).
                    '">查看图刊</a></li>';
...
EOB;
    ...
    private function show_menu($menu_key) {
        $menu_array = array(
            'list'=>array('menu_type'=>'link','menu_name'=>Language::get('wt_list'),'menu_url'=>urlAdminCms('news_picture','news_picture_list')),
            'list_verify'=>array('menu_type'=>'link','menu_name'=>Language::get('news_article_list_verify'),'menu_url'=>urlAdminCms('news_picture','news_picture_list_verify')),
            'list_published'=>array('menu_type'=>'link','menu_name'=>Language::get('news_article_list_published'),'menu_url'=>urlAdminCms('news_picture','news_picture_list_published')),
        );
