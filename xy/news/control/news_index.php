...
Tpl::showpage('news_index_module.edit');
    ...
    public function save_page_moduleWt() {
        ...
        if($result) {
            ...
            showMessage(Language::get('wt_common_save_succ'), urlAdminCms('news_index','news_index'));
        } else {
    ...
    private function show_menu($menu_key) {
        $menu_array = array(
            'news_index'=>array('menu_type'=>'link','menu_name'=>Language::get('wt_manage'),'menu_url'=>urlAdminCms('news_index','news_index')),
        );
