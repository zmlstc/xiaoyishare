...
Tpl::showpage("news_article.list");
    ...
    public function news_article_list_xmlWt()
    {
        ...
        foreach ($list as $val) {
            ...
            $o .= '<li><a target="_blank" href="'.urlNews('article','article_detail',array('article_id'=>$val['article_id'])).'">查看文章</a></li>';
...
EOB;
    ...
    private function show_menu($menu_key) {
        $menu_array = array(
            'list'=>array('menu_type'=>'link','menu_name'=>Language::get('wt_list'),'menu_url'=>urlAdminCms('news_article','news_article_list')),
            'list_verify'=>array('menu_type'=>'link','menu_name'=>Language::get('news_article_list_verify'),'menu_url'=>urlAdminCms('news_article','news_article_list_verify')),
            'list_published'=>array('menu_type'=>'link','menu_name'=>Language::get('news_article_list_published'),'menu_url'=>urlAdminCms('news_article','news_article_list_published')),
        );
