...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="<?php echo urlAdminCms('news_special','news_special_list');?>" title="返回专题列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
  ...
  <form id="add_form" method="post" enctype="multipart/form-data" action="<?php echo urlAdminCms('news_special','news_special_save');?>">
