...
<div id="dialog_verify" style="display:none;">
  <form id="verify_form" method='post' action="<?php echo urlAdminCms('news_article','news_article_verify');?>">
...
$(function(){
    ...
    var flexUrl = '<?php echo urlAdminCms('news_article','news_article_list_xml',array('article_state'=>$output['currentState']));?>';
        ...
        buttons: [
            {
                ...
                onpress: function() {
                    ...
                    location.href = '<?php echo urlAdminCms('news_article','news_article_drop');?>?article_id=__IDS__'.replace('__IDS__', ids.join(','));
                }
            }
        ],
        searchitems: [
...
$("a[data-j='drop']").live('click', function() {
    ...
    location.href = '<?php echo urlAdminCms('news_article','news_article_drop');?>?article_id='+id;
});
...
$("a[data-j='callback']").live('click', function() {
    ...
    var id = $(this).parents('tr[data-id]').attr('data-id');
    location.href = '<?php echo urlAdminCms('news_article','news_article_callback');?>?article_id=' + id;
});
...
$("a[data-j='article_commend_flag'],a[data-j='article_commend_image_flag'],a[data-j='article_comment_flag'],a[data-j='article_attitude_flag']").live('click', function() {
    ...
    var id = $(this).parents('tr[data-id]').attr('data-id');
    $.get('<?php echo urlAdminCms('news_article','ajax');?>', {
        column: column,
        id: id,
        value: value
    }, function(d) {
...
$("span[data-live-inline-edit]").live('click', function() {
    ...
    $input.change(function() {
        ...
        $.getJSON('index.php/news_article/update_' + column, {
