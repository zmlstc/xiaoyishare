...
<div id="dialog_verify" style="display:none;">
  <form id="verify_form" method='post' action="<?php echo urlAdminCms('news_picture','news_picture_verify');?>">
...
$(function(){
    ...
    var flexUrl = '<?php echo urlAdminCms('news_picture','news_picture_list_xml',array('picture_state'=>$output['currentState']));?>';
        ...
        buttons: [
            {
                ...
                onpress: function() {
                    ...
                    location.href = '<?php echo urlAdminCms('news_picture','news_picture_drop');?>?picture_id=__IDS__'.replace('__IDS__', ids.join(','));
                }
            }
        ],
        searchitems: [
...
$("a[data-j='drop']").live('click', function() {
    ...
    location.href = '<?php echo urlAdminCms('news_picture','news_picture_drop');?>?picture_id='+id;
});
...
$("a[data-j='callback']").live('click', function() {
    ...
    var id = $(this).parents('tr[data-id]').attr('data-id');
    location.href = '<?php echo urlAdminCms('news_picture','news_picture_callback');?>?picture_id=' + id;
});
...
$("a[data-j='picture_commend_flag'],a[data-j='picture_comment_flag']").live('click', function() {
    ...
    var id = $(this).parents('tr[data-id]').attr('data-id');
    $.get('<?php echo urlAdminCms('news_picture','ajax');?>', {
        column: column,
        id: id,
        value: value
    }, function(d) {
...
$("span[data-live-inline-edit]").live('click', function() {
    ...
    $input.change(function() {
        ...
        $.getJSON('index.php/news_picture/update_' + column, {
