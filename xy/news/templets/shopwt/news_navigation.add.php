...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="<?php echo urlAdminCms('news_navigation','news_navigation_list');?>" title="返回列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
  ...
  <form id="add_form" method="post" action="<?php echo urlAdminCms('news_navigation','news_navigation_save');?>">
