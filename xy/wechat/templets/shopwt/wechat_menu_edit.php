...
<div class="page">
 <div class="fixed-bar">
      <div class="item-title"><a class="back" href="<?php echo urlAdminWechat('menu');?>" title="返回列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
...
function setformvalue(){
	...
	if(mtype==1){//display material
		...
		if(material_id==0){
			...
			$.getJSON('<?php echo  urlAdminWechat('menu','ajax',array('branch'=>'get_material');?>?mid='+material_id, '', function(data){
...
function get_material_list(){//查询商品
	...
	$("#show_material_list").load('<?php echo urlAdminWechat('material','material_list');?>?'+$.param({'type':material_type}));
}
