...
<div class="flexigrid">
	...
	<div class="tDiv">
		<div class="tDiv2">
			<div class="fbutton">
				<div class="add" title="添加一条新数据到列表"><span><i class="fa fa-plus"></i><a href="<?php echo  urlAdminWechat('menu','menu_add');?>">新增数据</a></span>
				</div>
			</div>
		</div>
						...
						<td class="handle" align="center">
							<div style="text-align: center; width: 60px;">
								<span class="btn"><em><i class="fa fa-cog"></i>操作 <i class="arrow"></i></em><ul>
									...
									<li><a href="<?php echo urlAdminWechat('menu','menu_publish',array('mid'=>$value['menu_id']));?>">同步</a></li>
									<?php }?><li><a href="<?php echo urlAdminWechat('menu','menu_edit',array('mid'=>$value['menu_id']));?>">编辑</a></li><li><a href="javascript:void(0);" onclick="if(confirm('您确定要删除吗？')){location.href='index.php/menu/menu_del?mid=<?php echo $value['menu_id'];?>';}">删除</a></li></ul></span>
							</div>
						</td>
						<td>
