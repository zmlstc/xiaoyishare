	...
	<div class="bDiv" style="height: auto;">
 	 ...
 	 <div class="list">
        ...
        <div class="item multi">
		  ...
		  <?php }?>
          <div class="mod_del">
            <div class="mod"><a href="<?php echo urlAdminWechat('material','material_edit',array('mid'=>$value['material_id']));?>"><img src="<?php echo ADMIN_TEMPLATES_URL?>/css/weixin/mod.gif" /></a></div>
            <div class="del"><a href="<?php echo urlAdminWechat('material','material_del',array('mid'=>$value['material_id']));?>" onClick="if(!confirm('<?php echo $lang['material_delete_tips'];?>')){return false};"><img src="<?php echo ADMIN_TEMPLATES_URL?>/css/weixin/del.gif" /></a></div>
          </div>
        </div>
        <?php }else{?>
        <div class="item one">
