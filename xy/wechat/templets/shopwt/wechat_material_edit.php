...
<div class="page">
	 <div class="fixed-bar">
      <div class="item-title"><a class="back" href="<?php echo urlAdminWechat('material');?>" title="返回列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
...
$(function(){
	...
	function ajaxFileUpload(){
		...
		(
			{
				url:'<?php echo urlAdminWechat('common','pic_upload');?>?form_submit=ok&uploadpath=weixin/material',
				secureuri:false,
				fileElementId:'_pic',
				dataType: 'json',
