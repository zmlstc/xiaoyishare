...
<div class="flexigrid">
	...
	<div class="tDiv">
		<div class="tDiv2">
			<div class="fbutton">
				<div class="add" title="添加一条新数据到列表"><span><i class="fa fa-plus"></i><a href="<?php echo urlAdminWechat('keyword','keyword_add');?>">新增数据</a></span>
				</div>
			</div>
		</div>
				...
				<tbody>
					...
					<tr>
						...
						<td class="handle" align="center">
							<div style="text-align: center; width: 150px;"><a class="btn blue" href="index.php/keyword/keyword_edit?rid=<?php echo $value['reply_id'];?>"><i class="fa fa-pencil-square-o"></i>编辑</a><a class="btn blue" href="javascript:void(0)" onclick="if(confirm('确认删除？')){location.href='index.php/keyword/keyword_del?rid=<?php echo $value['reply_id'];?>';}"><i class="fa fa-pencil-square-o"></i>删除</a>
							</div>
						</td>
						<td class="" align="left">
