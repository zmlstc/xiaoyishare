...
<div class="page">
	<div class="fixed-bar">
		<div class="item-title"><a class="back" href="<?php echo  urlAdminWechat('keyword');?>" title="返回列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
			<div class="subject">
				<h3>
	...
	$('#add_form').validate({
        ...
        rules : {
            keywords : {
                required : true,
                remote   : {                
                url :'<?php echo  urlAdminWechat('menu','ajax',array('branch'=>'check_keywords'));?>',
                type:'get',
                data:{
                    keywords : function(){
                        return $('#keywords').val();
