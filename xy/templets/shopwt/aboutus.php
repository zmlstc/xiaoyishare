  ...
  <div class="content">
    ...
    <div class="scrollbar switchbox" style="display: none;">
      <div class="law-notice">
        <p>版权所有： <a href="http://www.shopwt.com" target="_blank">http://www.shopwt.com</a>。</p>
          感谢您选择ShopWTB2B2C电商平台系统。希望我们的努力能为您提供一个高效快速和强大的企业级电子商务整体解决方案。</p>
        <p>ShopWT官方网站（www.shopwt.com）属于深圳市米讯达信息技术有限公司所有。</p>
        <p>尊爱网络环境！禁止非法传播。</p>
      </div>
    </div>
    <div class="switchbox" style="display:none;" >
      <ul>
        ...
        <li>
          <h4>关注我们</h4>
          <p><?php echo $lang['dashboard_aboutus_website'];?> <a href="http://www.shopwt.com" target="_blank">http://www.shopwt.com</a></p>
