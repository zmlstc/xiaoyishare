...
class accountControl extends SystemControl{
    private $links = array(
        array('url'=>'account/qq','lang'=>'qqSettings'),
        array('url'=>'account/sina','lang'=>'sinaSettings'),
        array('url'=>'account/sms','text'=>'手机短信'),
        array('url'=>'account/wx','text'=>'微信登录'),
		//array('url'=>'account/uc','text'=>'UC互联')  //临时注释
    );
