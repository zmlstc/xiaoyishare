...
class messageControl extends SystemControl{
    private $links = array(
        array('url'=>'message/email','lang'=>'email_set'),
        array('url'=>'message/email_tpl','lang'=>'email_tpl')
    );
        ...
        if (chksubmit()){
            ...
            if ($error != ''){
                ...
                if ($result === true){
                    ...
                    showMessage(L('mailtemplates_edit_succ'),urlAdminSystem('message','email_tpl'));
                }else {
