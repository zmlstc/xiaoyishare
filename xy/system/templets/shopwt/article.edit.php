...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="<?php echo urlAdminSystem('article','article');?>" title="返回列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
...
$(document).ready(function(){
    ...
    $('#fileupload').each(function(){
        $(this).fileupload({
            dataType: 'json',
            url: '<?php echo urlAdminSystem('article','article_pic_upload',array('item_id'=>$output['article_array']['article_id']));?>',
...
function del_file_upload(file_id)
{
    ...
    $.getJSON('<?php echo urlAdminSystem('article','ajax',array('branch'=>'del_file_upload'));?>?file_id=' + file_id, function(result){
        if(result){
            $('#' + file_id).remove();
        }else{
