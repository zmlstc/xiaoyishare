 ...
 <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3>计划任务</h3>
        <h5>计划触发相关设置</h5>
      </div> <ul class="tab-base wt-row"><li><a class="current"><span><?php echo $lang['wt_list'];?></span></a></li><li><a href="<?php echo urlAdminSystem('task','add');?>"><span><?php echo $lang['wt_add'];?></span></a></li></ul>    </div>
  </div>
  ...
  <table class="flex-table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="handle"><a class="btn blue" href="<?php echo urlAdminSystem('task','edit',array('id'=>$v['id']));?>'><?php echo $lang['wt_edit'];?></a>"><i class="fa fa-pencil-square-o"></i><?php echo $lang['wt_edit'];?></a>
        <a href="javascript:;" onClick="(window.confirm('你确实要删除这个任务么！') ? location='<?php echo urlAdminSystem('task','del',array('id'=>$v['id']));?>' : '')" class="btn red"><i class="fa fa-trash-o"></i><?php echo $lang['wt_del'];?></a>
        </td>
        <td><?php echo $v['id']; ?></td>
