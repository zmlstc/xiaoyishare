    ...
    <table class="flex-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="handle-s"><a class="btn blue" href="<?php echo urlAdminSystem('message','email_tpl_edit',array('code'=>$v['code']));?>"><i class="fa fa-pencil-square-o"></i><?php echo $lang['wt_edit'];?></a></td>
...
function go(){
	var url="<?php echo urlAdminSystem('message','email_tpl_ajax');?>";
