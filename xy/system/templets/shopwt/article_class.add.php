...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="<?php echo urlAdminSystem('article_class','article_class');?>" title="返回列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
	...
	$('#article_class_form').validate({
        ...
        rules : {
            ac_name : {
                required : true,
                remote   : {                
                url :'<?php echo urlAdminSystem('article_class','ajax',array('branch'=>'check_class_name'));?>',
                type:'get',
                data:{
                    ac_name : function(){
                        return $('#ac_name').val();
