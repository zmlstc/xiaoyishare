...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="<?php echo urlAdminSystem('admin','admin');?>" title="返回列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
  ...
  <form id="admin_form" method="post" action='<?php echo urlAdminSystem('admin','admin_edit',array('admin_id'=>$output['admininfo']['admin_id']));?>'>
