  ...
  <table class="flex-table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="handle-s"><a class="btn blue" href="<?php echo urlAdminSystem('document','edit',array('doc_id'=>$v['doc_id']));?>"><i class="fa fa-pencil-square-o"></i><?php echo $lang['wt_edit'];?></a></td>
