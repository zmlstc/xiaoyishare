...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <li><a href="<?php echo urlAdminSystem('task','list');?>"><span><?php echo $lang['wt_list'];?></span></a></li>
      <li><a href="javascript:;" class="current"><span><?php echo $lang['wt_edit'];?></span></a></li>
      <li><a href="<?php echo urlAdminSystem('task','add');?>"><span><?php echo $lang['wt_add'];?></span></a></li>
      </ul>
	  </div>
  </div>
