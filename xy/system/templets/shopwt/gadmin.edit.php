...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="<?php echo urlAdminSystem('admin','gadmin');?>" title="返回列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
	...
	$("#add_form").validate({
        ...
        rules : {
            gname : {
                required : true,
				remote	: {
                    url :'<?php echo urlAdminSystem('admin','ajax',array('branch'=>'check_gadmin_name','gid'=>$output['ginfo']['gid']));?>',
                    type:'get',
                    data:{
                    	gname : function(){
                            return $('#gname').val();
