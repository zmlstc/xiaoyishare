...
<div class="flexigrid">
	...
	<div class="tDiv">
		<div class="tDiv2">
			<div class="fbutton">
				<div class="add" title="备份数据"><span><i class="fa fa-plus"></i><a href="<?php echo urlAdminSystem('db','db');?>">备份数据</a></span>
				</div>
			</div>
		</div>
						...
						<td class="handle" align="center">
							<div style="text-align: center; width: 60px;">
								<span class="btn"><em><i class="fa fa-cog"></i>操作 <i class="arrow"></i></em><ul>
									<li><a href="javascript:if(confirm('<?php echo $lang['db_index_backup_tip'];?>?')){location.href='<?php echo urlAdminSystem('db','db_import');?>?dir_name=<?php echo $v['name'];?>&step=1'};"><?php echo $lang['db_restore_import'];?></a></li>
									<li><a href="javascript:if(confirm('<?php echo $lang['wt_ensure_del'];?>')){location.href='<?php echo urlAdminSystem('db','db_del');?>?dir_name=<?php echo $v['name'];?>'};"><?php echo $lang['wt_del'];?></a></li></ul></span>
							</div>
						</td>
						<td>
