...
Tpl::showpage('mb_category.list');
    ...
    public function mb_category_delWt(){
        ...
        if (intval($_GET['gc_id']) > 0){
            ...
            showMessage($lang['link_index_del_succ'],urlAdminMobile('mb_category','mb_category_list'));
        }else {
            showMessage($lang['link_index_choose_del'],urlAdminMobile('mb_category','mb_category_list'));
        }
    }
    ...
    public function mb_category_addWt(){
        ...
        if ($_POST['form_submit'] == 'ok'){
            ...
            if ($result){
                $url = array(
                    array(
                        'url'=>urlAdminMobile('mb_category','mb_category_add'),
                        'msg'=>$lang['link_add_again'],
                    ),
                    array(
                        'url'=>urlAdminMobile('mb_category','mb_category_list'),
    ...
    public function mb_category_editWt(){
        ...
        if ($_POST['form_submit'] == 'ok'){
            ...
            if ($result){
                ...
                $url = array(
                    array(
                        'url'=>urlAdminMobile('mb_category','mb_category_edit',array('gc_id'=>intval($_POST['gc_id']))),
