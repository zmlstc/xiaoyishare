...
<div class="page">
  ...
  <form id="post_form" method="post">
    ...
    <div class="wtap-form-default">
      ...
      <div class="bot"> <a href="JavaScript:void(0);" class="wtap-btn-big wtap-btn-green" id="submitBtn"><?php echo $lang['wt_submit'];?></a><a href="<?php echo urlAdminMobile('mb_app','mb_qr');?>"  class="wtap-btn-big wtap-btn-orange ml10">生成二维码</a> </div>
    </div>
  </form>
</div>
<script>
