...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3>红包管理</h3>
      <ul class="tab-base">
        <li><a href="<?php echo urlAdminMobile('mb_redpacket');?>"><span><?php echo $lang['wt_manage'];?></span></a></li>
        <li><a href="<?php echo urlAdminMobile('mb_redpacket','new');?>"><span><?php echo $lang['wt_new'];?></span></a></li>
