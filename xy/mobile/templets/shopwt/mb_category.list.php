    ...
    <table class="flex-table">
      ...
      <tbody>
        ...
        <tr class="edit">
          ...
          <td class="handle"><a href="javascript:if(confirm('<?php echo $lang['wt_ensure_del'];?>'))window.location = '<?php echo urlAdminMobile('mb_category','mb_category_del',array('gc_id'=>$v['gc_id']));?>';" class="btn red"><i class="fa fa-trash-o"></i><?php echo $lang['wt_del'];?></a><a href="<?php echo urlAdminMobile('mb_category','mb_category_edit',array('gc_id'=>$v['gc_id']));?>" class="btn blue"><i class="fa fa-pencil-square-o"></i><?php echo $lang['wt_edit'];?></a></td>
...
$(function(){
    ...
    if (name == 'add') {
        window.location.href = '<?php echo urlAdminMobile('mb_category','mb_category_add');?>';
    }
}
</script>