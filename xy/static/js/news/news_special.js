$(document).ready(function(){
    ...
    $("#picture_image_upload").fileupload({
        dataType: 'json',
            url: "index.php/news_special/special_image_upload",
            add: function(e,data) {
    ...
    $("[wttype='btn_drop_special_image']").live("click",function(){
        ...
        $.getJSON("index.php/news_special/special_image_drop", { image_name: image_name }, function(result){
                if(result.status == "success") {
                    image_object.remove();
                } else {
    ...
    $("[wttype='btn_special_goods']").live('click', function(){
        ...
        $.getJSON("index.php/news_special/goods_content_by_url", { url: url}, function(data){
            if(data.result == "true") {
