...
$(function(){
    ...
    $('#btn_video_upload').fileupload({
        dataType: 'json',
        url: ADMIN_SITE_URL+'/index.php/lib_goods/video_upload',
    ...
    $('#goods_image').fileupload({
        dataType: 'json',
        url: ADMIN_SITE_URL+'/index.php/lib_goods/image_upload?upload_type=uploadedfile',
    ...
    $('#add_album').fileupload({
        dataType: 'json',
        url: ADMIN_SITE_URL+'/index.php/lib_goods/image_upload',
    ...
    $('a[wttype="mb_add_img"]').click(function(){
        $('a[wttype="meat_cancel"]').click();
        $('div[wttype="mea_img"]').show().load(ADMIN_SITE_URL+'/index.php/lib_goods/pic_list?item=mobile');
    });
    // 关闭 图片选择
    ...
    $('div[wttype="mobile_pannel"]').on('click', 'a[wttype="mp_rpl"]', function(){
        $('a[wttype="meat_cancel"]').click();
        $('div[wttype="mea_img"]').show().load(ADMIN_SITE_URL+'/index.php/lib_goods/pic_list?item=mobile&type=replace');
    });
    // 插图图片
