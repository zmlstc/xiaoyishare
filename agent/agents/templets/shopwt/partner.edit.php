...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?w=partner&t=partner" title="返回列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
        <h3>合伙人管理 - 编辑’ <?php echo $output['partner_array']['partner_name'];?> ‘合伙人</h3>
        <h5>合伙人信息设置管理</h5>
      </div>
  ...
  <form id="user_form" enctype="multipart/form-data" method="post">
	...
	<input type="hidden" name="partner_id" value="<?php echo $output['partner_array']['partner_id'];?>" />
    <div class="wtap-form-default">
        ...
        <dd class="opt">
          <input type="text" value="<?php echo $output['partner_array']['partner_name'];?>" name="partner_name" id="partner_name" class="input-txt">
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" id="partner_jobnum" name="partner_jobnum" class="input-txt" value="<?php echo $output['partner_array']['partner_jobnum'];?>">
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
	  ...
	  <dl class="row">
        ...
        <dd class="opt">
          <input type="text" value="<?php echo $output['partner_array']['partner_name'];?>" id="partner_mobile" name="partner_mobile" class="input-txt">
        ...
        <dd class="opt">
          <select id="partner_way" name="partner_way">
            <option value="1" <?php if($output['partner_array']['partner_way']==1){ echo 'selected=selected';}?>>按比例</option>
          <option value="2"  <?php if($output['partner_array']['partner_way']==2){ echo 'selected=selected';}?>>定额</option>
          </select>
          <span class="err"></span></dd>
      </dl>
      <dl class="row" id="select-way2"  <?php if($output['partner_array']['partner_way']==2){ echo 'style="display:block;"';}else{echo 'style="display:none;"';}?>>
        <dt class="tit">
          <label for="partner_guding">定额</label>
        </dt>
        <dd class="opt">
          <input type="text" value="<?php echo $output['partner_array']['partner_guding'];?>" id="partner_guding" name="partner_guding" class="input-txt">元
          <span class="err"></span></dd>
      </dl>
	  <dl class="row" id="select-way1"  <?php if($output['partner_array']['partner_way']==1){ echo 'style="display:block;"';}else{ echo 'style="display:none;"';}?>>
        <dt class="tit">
          <label for="partner_rate">提成比例</label>
        </dt>
        <dd class="opt">
          <input type="text" value="<?php echo $output['partner_array']['partner_rate'];?>" id="partner_rate" name="partner_rate" class="input-txt">%
          <span class="err"></span></dd>
      </dl>
		 <dl class="row">
        <dt class="tit">
       ...
       <dd class="opt">
          <textarea name="partner_txt" rows="2" class="textarea w400"  maxlength="50" ><?php echo $output['partner_array']['partner_txt'];?></textarea>
        <p class="err"></p>
      </dd>
    </dl>
