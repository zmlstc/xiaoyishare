...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="<?php echo urlAgentAgents('store','store_joinin');?>" title="返回<?php echo $lang['pending'];?>列表"><i class="fa fa-arrow-bbs-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['wt_store_manage'];?> - 查看店铺注册信息</h3>
  ...
  <form id="form_store_verify" action="<?php echo urlAgentAgents('store','store_joinin_verify');?>" method="post">
...
<script type="text/javascript" src="<?php echo AGENTS_STATIC_URL;?>/js/jquery.nyroModal.js"></script>
