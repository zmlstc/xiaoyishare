...
<tr><td colspan="4" style="border-bottom:1px solid #ccc"><h3 style="font-size:20px Arial,Verdana,'宋体';line-height:60px"><?php echo C('site_name');?> - 代理结算单</h3></td></tr>
<tr>
<td width="80px">代理</td><td colspan="3"><?php echo $output['bill_info']['ob_agent_name'];?></td>
</tr>
...
<?php } ?>
<tr><td>代理应收</td><td><?php echo wtPriceFormat($output['bill_info']['ob_result_totals']);?></td></tr>
<tr><td colspan="2">结算明细</td></tr>
<tr><td colspan="4"> <?php echo wtPriceFormat($output['bill_info']['ob_commis_totals']);?> (平台佣金金额) * <?php echo $output['bill_info']['ob_commis'];?>% (结算比例)
