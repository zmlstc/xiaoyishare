...
<script type="text/javascript" src="<?php echo AGENTS_STATIC_URL?>/js/highcharts.js"></script>
<script type="text/javascript" src="<?php echo AGENTS_STATIC_URL?>/js/statistics.js"></script>
<link rel="stylesheet" type="text/css" href="<?php echo AGENTS_STATIC_URL;?>/js/map/jquery.vector-map.css"/>
<script type="text/javascript" src="<?php echo AGENTS_STATIC_URL;?>/js/map/jquery.vector-map.js"></script>
<script type="text/javascript" src="<?php echo AGENTS_STATIC_URL;?>/js/map/china-zh.js"></script>
<script>
$(function () {
