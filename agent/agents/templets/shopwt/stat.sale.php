...
<script type="text/javascript" src="<?php echo AGENTS_STATIC_URL?>/js/jquery.numberAnimation.js"></script>
...
$(function () {
	...
	$("[name='searchweek_month']").change(function(){
		...
		$.getJSON('<?php echo AGENTS_SITE_URL?>/index.php?w=common&t=getweekofmonth',{y:year,m:month},function(data){
	        if(data != null){
