	  ...
	  <div class="con">
		...
		<div class="submit">
			   <span class="user-code">
				<div class="code">
				  <div class="arrow"></div>
				  <div class="code-img"><img src="/agent/index.php/vercode" name="codeimage" id="codeimage" border="0"/></div>
				  <a href="JavaScript:void(0);" id="hide" class="close" title="<?php echo $lang['login_index_close_checkcode'];?>"><i></i></a><a href="JavaScript:void(0);" onclick="javascript:document.getElementById('codeimage').src='/agent/index.php/vercode/type/30x92?c=' + Math.random();" class="change" title="<?php echo $lang['login_index_change_checkcode'];?>"><i></i></a> </div>
