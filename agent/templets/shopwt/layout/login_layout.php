...
<link href="<?php echo AGENTS_TEMPLATES_URL;?>/css/login.css" rel="stylesheet" type="text/css">
...
<script src="<?php echo AGENTS_STATIC_URL?>/js/jquery.supersized.min.js" ></script>
<script src="<?php echo AGENTS_STATIC_URL?>/js/jquery.progressBar.js" type="text/javascript"></script>
...
$(function(){
        ...
        slide_links        : 'blank',    
        slides             : [    
							 {image : '<?php echo AGENTS_TEMPLATES_URL;?>/images/login/3.jpg'}
                       ]
   ...
   if(top.location!=this.location)	top.location=this.location;
    ...
    if ($.browser.msie && ($.browser.version=="6.0" || $.browser.version=="7.0")){
        window.location.href='<?php echo AGENTS_TEMPLATES_URL;?>/ie6update.html';
    }
