...
var LOADING_IMAGE = "<?php echo AGENTS_TEMPLATES_URL.DS.'images/loading.gif';?>";
...
<script type="text/javascript" src="<?php echo AGENTS_STATIC_URL;?>/js/jquery-ui/i18n/zh-CN.js"></script>
<script type="text/javascript" src="<?php echo AGENTS_STATIC_URL?>/js/admin.js"></script>
<script type="text/javascript" src="<?php echo AGENTS_STATIC_URL?>/js/dialog/dialog.js" id="wt_dialog"></script>
<script type="text/javascript" src="<?php echo AGENTS_STATIC_URL?>/js/flexigrid.js"></script>
...
<script type="text/javascript" src="<?php echo AGENTS_STATIC_URL?>/js/jquery.picTip.js"></script>
