...
$(function(){
    ...
    $('#product_list').on('click', '.goods-store a',function(){
        ...
        $.getJSON(ApiUrl + '/index.php/store/store_credit', {store_id:store_id}, function(result){
            var html = '<dl>'
...
function get_list() {
    ...
    $.getJSON(ApiUrl + '/index.php/goods/goods_dzlist?' + window.location.search.replace('?','&'), param, function(result){
    	if(!result) {
    		result = [];
    		result.datas = [];
...
function search_show() {
    $.getJSON(ApiUrl + '/index.php/index/search_show', function(result) {
