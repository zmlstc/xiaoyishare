...
var password,rcb_pay,pd_pay,payment_code;
	     ...
	     $('#paypal').click(function() {
             ...
             $('#toPay').click(function(){
                 ...
                 if (_use_password) {
                     ...
                     $.ajax({
                         type:'post',
                         url:ApiUrl+'/index.php/member_buy/check_pd_pwd',
                         dataType:'json',
 ...
 function goToPayment(pay_sn,t) {
     location.href = ApiUrl+'/index.php/member_payment/'+t+'?key=' + key + '&pay_sn=' + pay_sn + '&password=' + password + '&rcb_pay=' + rcb_pay + '&pd_pay=' + pd_pay + '&payment_code=' + payment_code;
 }
