...
$(function() { 
    ...
    function t() {
        ...
        $.ajax({
            type: "post",
            url: ApiUrl + "/index.php/member_pointorder/orderlist?page=" + page + "&curpage=" + curpage,
            data: {
                key: e,
                state_type: t,
                order_key: r
    ...
    function s(r) {
        $.ajax({
            type: "post",
            url: ApiUrl + "/index.php/member_pointorder/receiving_order",
            data: {
                order_id: r,
                key: e
            },
    ...
    function a(r) {
        $.ajax({
            type: "post",
            url: ApiUrl + "/index.php/member_pointorder/cancel_order",
            data: {
                order_id: r,
                key: e
            },
