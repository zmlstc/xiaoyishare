...
$(function(){
    $.getJSON( ApiUrl+'/index.php/member_chat/get_node_info',{key:key,u_id:t_id,chat_goods_id:chat_goods_id}, function(result){
...
//                }
                function node_send_msg(data){
                    if(connect === 1) {
                        $.ajax({
                            type:'post',
                            url:ApiUrl+'/index.php/member_chat/send_msg',
                            data:data,
                            dataType:'json',
...
//                }
        ...
        $('#chat_msg_log').click(function(){
            $.ajax({
                type:'post',
                url:ApiUrl+'/index.php/member_chat/get_chat_log?page=50',
