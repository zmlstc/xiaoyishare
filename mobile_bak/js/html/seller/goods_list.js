...
$(function() {
    ...
    function t() {
        ...
        $.ajax({
            type: "post",
            url: ApiUrl + "/index.php/seller_goods/goods_list?page=" + page + "&curpage=" + curpage,
            data: {
                key: e,
                state_type: t,
                keyword : r
            ...
            success: function(e) {
                ...
                function goods_delete(commonid){
                    $.ajax({
                        type: "post",
                        url: ApiUrl + "/index.php/seller_goods/goods_drop",
                        data: {
                            key: key,
                            commonids:commonid,
                        },
                ...
                function goods_unshow(commonid){
                    $.ajax({
                        type: "post",
                        url: ApiUrl + "/index.php/seller_goods/goods_unshow",
                        data: {
                            key: key,
                            commonids:commonid,
                        },
    ...
    function i(r) {
        $.ajax({
            type: "post",
            url: ApiUrl + "/index.php/member_order/order_delete",
            data: {
                order_id: r,
                key: e
            },
