;(function($){
    ...
    $(".submit").click(function(){
        if($.sValid()){
            ...
            $.ajax({
                url: ApiUrl + "/index.php/seller_goods/save_goods",
                type: 'POST',
                dataType: 'json',
...
;(function($){
    ...
    //动态加载
    $.ajax({
        url: ApiUrl + "/index.php/seller_goods/goods_add",
        type: 'POST',
        dataType: 'json',
    ...
    $("#msform").delegate("#goodsClassStapleArea", 'change', function() {
        ...
        if (stapleId > 0) {
            $.ajax({
                url: ApiUrl + "/index.php/seller_goods/ajax_show_comm",
                type: 'POST',
                dataType: 'json',
    ...
    $("#msform").delegate(".gc-select", 'change', function() {
        ...
        if (gc_id > 0 && deep <= 3) {
            next_select.remove();
            $.ajax({
                url: ApiUrl + "/index.php/seller_goods/ajax_goods_class",
                type: 'POST',
                dataType: 'json',
    ...
    $('#goods_image').fileupload({
        dataType: 'json',
        url: ApiUrl + '/index.php/seller_goods/ajax_image_upload?upload_type=uploadedfile',
