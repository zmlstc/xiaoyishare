...
//                }
                function node_send_msg(data){
                    if(connect === 1) {
                        $.ajax({
                            type:'post',
                            url:ApiUrl+'/index.php/seller_chat/send_msg',
                            data:data,
                            dataType:'json',
...
//                }
        ...
        $('#chat_msg_log').click(function(){
            $.ajax({
                type:'post',
                url:ApiUrl+'/index.php/seller_chat/get_chat_log?page=50',
		...
		$('input[name="_pic"]').ajaxUploadImage({
				url: ApiUrl + "/index.php/member_chat/image_send",
				data: {
					key: key,
					name: "_pic"
				},
