$(function() {
    ...
    $.ajax({
                type: "post",
                url: ApiUrl + "/index.php/seller_goods/goods_content",
                data: {
                    key: key,
    ...
    $.ajax({
                type: "post",
                url: ApiUrl + "/index.php/seller_goods/goods_image_info",
                data: {
                    key: key,
                    goods_commonid: commonid,
                },
    ...
    $('input[name="file"]').ajaxUploadImage({
            url : ApiUrl + "/index.php/seller_album/image_upload",
            data:{
                key:key,
                name:"file"
            },
    ...
    $(".btn").click(function() {
        if ($.sValid()) {
            ...
            $.ajax({
                type: "post",
                url: ApiUrl + "/index.php/seller_goods/goods_edit",
                data: {
                    key: key,
                    commonid:commonid,
                    cate_id: cate_id,
