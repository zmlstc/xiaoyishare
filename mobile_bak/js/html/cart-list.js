$(function (){
    ...
    if(!key){
        ...
        function initCartList(){
             $.ajax({
                url:ApiUrl+"/index.php/member_cart/cart_list",
                type:"post",
                dataType:"json",
                data:{key:key},
        ...
        function delCartList(cart_id){
            $.ajax({
                url:ApiUrl+"/index.php/member_cart/cart_del",
                type:"post",
	    ...
	    var goods_id = sPrents.attr("goods_id");
            ...
            $.ajax({
                url:ApiUrl+"/index.php/member_cart/cart_edit_quantity",
                type:"post",
...
function getGoods(goods_id, goods_num){
    ...
    $.ajax({
        type:'get',
        url:ApiUrl+'/index.php/goods/goods_detail?goods_id='+goods_id + "&quanity=" + goods_num,
        dataType:'json',
        async:false,
        success:function(result){
            if (result.datas.error) {
