$(function() {
    ...
    $.ajax({
        type:'get',
        url:ApiUrl+"/index.php/member_account/get_mobile_info",
        data:{key:key},
        dataType:'json',
    ...
    $('#send').click(function(){
            ...
            $.ajax({
                type:'post',
                url:ApiUrl+"/index.php/member_account/modify_mobile_step2",
    ...
    $('#nextform').click(function(){
        ...
        if (auth_code) {
            $.ajax({
                type:'post',
                url:ApiUrl+"/index.php/member_account/modify_mobile_step3",
