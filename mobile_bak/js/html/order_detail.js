$(function(){
    ...
    $.getJSON(ApiUrl + '/index.php/member_order/order_info',{key:key,order_id:getQueryString('order_id')}, function(result) {
        ...
        $.ajax({
            type: 'post',
            url: ApiUrl + "/index.php/member_order/get_current_deliver",
